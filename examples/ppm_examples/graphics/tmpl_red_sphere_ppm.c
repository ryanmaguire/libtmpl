 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Draw a circle with a black-to-red gradient giving it the appearance   *
 *      of a 3D sphere.                                                       *
 ******************************************************************************/
...
/*  Function for drawing a sphere with a black-to-red gradient.               */
int main(void)
{
...
#pragma omp parallel for
    ...
    tmpl_Binary_PPM_From_Data("tmpl_sphere.ppm", data, width, height);
