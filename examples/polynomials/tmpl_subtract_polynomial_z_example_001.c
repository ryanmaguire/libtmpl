...
int main(void)
{
    ...
    /*  Create an empty polynomial to store the diff in.                      */
    ...
    /*  Compute the diff of P and Q, and store it in diff.                    */
    ...
    {
        fprintf(stderr,
                "tmpl_Polynomitmpl_PolynomialZ_AddalZ_Subtract set the error_occurred Boolean to\n"
                "true for the diff. It is likely malloc or realloc failed.\n"
