 ...
 ******************************************************************************
 *                    tmpl_create_vector_from_real_data.c                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Create a pointer to a vector from a pointer to a real-valued array.   *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Create_FloatVector_From_Data                                     *
 *      tmpl_Create_DoubleVector_From_Data                                    *
 *      tmpl_Create_LongDoubleVector_From_Data                                *
 *  Purpose:                                                                  *
 *      Given a pointer to a float/double/long double array, create a pointer *
 *      to a vector with the data set to this input array.                    *
 *  Arguments:                                                                *
 *      arr (float/double/long double *):                                     *
 *          A pointer to a real-valued array.                                 *
...
/*  Function for creating a single-precision vector from a float array.       */
tmpl_FloatVector *
tmpl_Create_FloatVector_From_Data(float *arr, unsigned long int length)
{
    ...
    if (arr == NULL)
    {
        ...
        vec->error_message = tmpl_strdup(
            ...
            "\tFunction Name: tmpl_Create_FloatVector_From_Data\n\n"
...
/*  End of tmpl_Create_FloatVector_From_Data.                                 */

/*  Function for creating a double-precision vector from a double array.      */
tmpl_DoubleVector *
tmpl_Create_DoubleVector_From_Data(double *arr, unsigned long int length)
{
    ...
    if (arr == NULL)
    {
        ...
        vec->error_message = tmpl_strdup(
            "Error Encountered: libtmpl\n"
            "\tFunction Name: tmpl_Create_DoubleVector_From_Data\n\n"
            "Input pointer is NULL but input length is not zero.\n"
            "Setting vec->data to NULL and returning.\n"
        );
...
/*  End of tmpl_Create_DoubleVector_From_Data.                                */

/*  Function for creating a long double-precision vector from a long double   *
 *  array.                                                                    */
                                       ...
                                       unsigned long int length)
{
    ...
    if (arr == NULL)
    {
        ...
        vec->error_message = tmpl_strdup(
            "Error Encountered: libtmpl\n"
            "\tFunction Name: tmpl_Create_LongDoubleVector_From_Data\n\n"
            "Input pointer is NULL but input length is not zero.\n"
            "Setting vec->data to NULL and returning.\n"
        );
