 ...
 ******************************************************************************
 *                  tmpl_symmetric_second_derivative_ldouble                  *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Symmetric_Second_Derivative                              *
 *  Purpose:                                                                  *
 ...
 *          long double (~10^-19 for 80-bit long double).                     *
 *      2.)                                                                   *
                                         ...
                                         long double x, long double h)
{
    ...
    const long double x0 = x - h;
    const long double x2 = x + h;

    /*  Evaluate the function at the stencil points.                          */
    const long double y0 = f(x0);
    const long double y1 = f(x);
    const long double y2 = f(x2);

    /*  Symmetric stencil has weights 1 and -2 for the second derivative.     */
    const long double num = y0 - 2.0L*y1 + y2;

    /*  The denominator is proportional to the square of the step size.       */
    const long double den = h * h;
    return num / den;
}
/*  End of tmpl_LDouble_Symmetric_Second_Derivative.                          */
