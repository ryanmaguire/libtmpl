...
double tmpl_Double_Derivative(double (*f)(double), double x)
{
    ...
    return tmpl_Double_Five_Point_Derivative(f, x, h);
}
/*  End of tmpl_Double_Derivative.                                            */
