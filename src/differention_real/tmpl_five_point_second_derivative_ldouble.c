 ...
 ******************************************************************************
 *                  tmpl_five_point_second_derivative_ldouble                 *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Five_Point_Second_Derivative                             *
 *  Purpose:                                                                  *
 *      Numerically computes the second derivative of a function.             *
 *  Arguments:                                                                *
 *      f (function):                                                         *
 *          A function that takes in a long double and returns a long double. *
 *      x (long double):                                                      *
 *          The point where f'' is to be computed.                            *
 *      h (long double):                                                      *
 *          Step size for the stencil.                                        *
 *  Output:                                                                   *
 *      f_double_prime (long double):                                         *
 ...
 *          precision of long double (~10^-19 for 80-bit long double).        *
 *      2.)                                                                   *
                                          ...
                                          long double x, long double h)
{
    ...
    const long double x0 = x - 2.0L*h;
    const long double x1 = x - 1.0L*h;
    const long double x3 = x + 1.0L*h;
    const long double x4 = x + 2.0L*h;

    /*  The evaluation of the function at the points of the stencil           */
    const long double y0 = f(x0);
    const long double y1 = f(x1);
    const long double y2 = f(x);
    const long double y3 = f(x3);
    const long double y4 = f(x4);
    ...
    const long double num = -y0 + 16.0L*y1 - 30.0L*y2 + 16.0L*y3 - y4;

    /*  The denominator is proportional to the square of the step size.       */
    const long double den = 12.0L * h * h;
    return num / den;
}
/*  End of tmpl_LDouble_Five_Point_Second_Derivative.                         */
