 ...
 ******************************************************************************
 *                     tmpl_symmetric_derivative_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Symmetric_Derivative                                     *
 *  Purpose:                                                                  *
                                  ...
                                  long double x, long double h)
{
    ...
    const long double num = y2 - y0;

    /*  The denominator is proportional to the step size.                     */
    const long double den = 2.0L * h;
    return num / den;
}
/*  End of tmpl_LDouble_Symmetric_Derivative.                                 */
