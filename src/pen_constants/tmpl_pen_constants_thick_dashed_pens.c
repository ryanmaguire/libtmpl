 ...
 ******************************************************************************
 *                    tmpl_pen_constants_thick_dashed_pens                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides pens used for drawing thick dashed lines and curves.         *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_pen_type.h:                                                      *
 *          Provides the typedef for the tmpl_Pen data type.                  *
 *  2.) tmpl_pen_thick_dashed_constants.h:                                    *
...
#include <libtmpl/include/constants/tmpl_pen_thick_dashed_constants.h>
...
static const char tmpl_pen_dash_char_array_thick_dashed_pen[4] = "8 8";
...
#define DASH tmpl_pen_dash_char_array_thick_dashed_pen

/*  Macro for creating a pen from a given RGBA24 color constant.              */
#define TMPL_DEFINE_PEN(Name) const tmpl_Pen \
tmpl_Pen_Thick_Dashed_##Name = {&tmpl_RGBA24_##Name, LINEWIDTH, DASH}
