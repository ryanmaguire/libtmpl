 ...
 ******************************************************************************
 *                       tmpl_pen_constants_default_pens                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides pens used for drawing ordinary lines and curves.             *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_pen_type.h:                                                      *
 *          Provides the typedef for the tmpl_Pen data type.                  *
 *  2.) tmpl_pen_default_constants.h:                                         *
...
#include <libtmpl/include/constants/tmpl_pen_default_constants.h>
