 ...
 ******************************************************************************
 *                   tmpl_pen_constants_densely_dashed_pens                   *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides pens used for drawing densely dashed lines and curves.       *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_pen_type.h:                                                      *
 *          Provides the typedef for the tmpl_Pen data type.                  *
 *  2.) tmpl_pen_densely_dashed_constants.h:                                  *
...
#include <libtmpl/include/constants/tmpl_pen_densely_dashed_constants.h>
...
static const char tmpl_pen_dash_char_array_densely_dashed_pen[4] = "4 4";

/*  Linewidth for the pens. tmpl_pen_type.h has TMPL_PEN_DEFAULT_LINEWIDTH.   */
#define LINEWIDTH TMPL_PEN_DEFAULT_LINEWIDTH

/*  The dash type for the pen. Given by the above char array.                 */
#define DASH tmpl_pen_dash_char_array_densely_dashed_pen

/*  Macro for creating a pen from a given RGBA24 color constant.              */
#define TMPL_DEFINE_PEN(Name) const tmpl_Pen \
tmpl_Pen_Densely_Dashed_##Name = {&tmpl_RGBA24_##Name, LINEWIDTH, DASH}
