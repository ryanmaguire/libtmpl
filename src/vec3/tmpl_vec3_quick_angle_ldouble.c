 ...
 *          tmpl_3DLDouble_Angle instead. That function safely handles such   *
 *          cases, but is slower.                                             *
 *  References:                                                               *
 *      Kahan, William                                                        *
                           ...
                           const tmpl_ThreeVectorLongDouble * const Q)
{
    ...
    const long double norm_cross = tmpl_3DLDouble_Quick_L2_Norm(&cross);
...
/*  End of tmpl_3DLDouble_Quick_Angle.                                        */
