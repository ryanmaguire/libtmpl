 ...
 *          tmpl_3DFloat_Angle instead. That function safely handles such     *
 *          cases, but is slower.                                             *
 *  References:                                                               *
 *      Kahan, William                                                        *
                         ...
                         const tmpl_ThreeVectorFloat * const Q)
{
    ...
    const float norm_cross = tmpl_3DFloat_Quick_L2_Norm(&cross);
...
/*  End of tmpl_3DFloat_Quick_Angle.                                          */
