 ...
 *                                                                            *
 *      3.) If tmpl_3DFloat_Cross_Product is the equivalent of the "x"        *
 *          operator for the tmpl_ThreeVectorFloat struct, this is the        *
 *          equivalent of "x=". It is about 2-3x faster to do                 *
 *                                                                            *
 *              tmpl_3DFloat_CrossWith(&p, &q);                               *
 *                                                                            *
 *          instead of doing                                                  *
 *                                                                            *
 *              p = tmpl_3DFloat_Cross_Product(&q, &q);                       *
 *                                                                            *
