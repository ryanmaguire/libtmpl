 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Print a color to a PPM file using the explicit RGB values.            *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *  Method:                                                                   *
 *      Use fprintf and print the contents of the RGB color to the file.      *
 *  Notes:                                                                    *
 ...
 *                                                                            *
 *      This function assumes the PPM is in text-based format. Binary PPM     *
 *      files should use tmpl_PPM_Write_Color_From_Values.                    *
 ******************************************************************************
 *                               DEPENDENCIES                                 *
 ******************************************************************************
 *  1.) tmpl_ppm.h:                                                           *
...
void tmpl_PPM_Print_Color_From_Values(FILE *fp,
                                      unsigned char red,
                                      unsigned char green,
                                      unsigned char blue)
{
...
/*  End of tmpl_PPM_Print_Color_From_Values.                                  */
