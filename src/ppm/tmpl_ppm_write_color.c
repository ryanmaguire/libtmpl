 ...
 *      files should use tmpl_PPM_Print_Color.                                *
 ******************************************************************************
 *                               DEPENDENCIES                                 *
 ******************************************************************************
 *  1.) tmpl_ppm.h:                                                           *
...
void tmpl_PPM_Write_Color(FILE *fp, tmpl_RGB24 color)
{
    fputc(color.dat[0], fp);
    fputc(color.dat[1], fp);
    fputc(color.dat[2], fp);
}
/*  End of tmpl_PPM_Write_Color.                                              */
