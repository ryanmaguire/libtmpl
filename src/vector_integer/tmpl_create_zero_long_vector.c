 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Create_Zero_LongVector                                           *
 *      tmpl_Create_Zero_ULongVector                                          *
 *  Purpose:                                                                  *
 *      Allocates memory for a long-valued vector and sets entries to zero.   *
 *  Arguments:                                                                *
 *      length (unsigned long int):                                           *
 *          The desired length of the vector.                                 *
 *  Output:                                                                   *
 *      vec (tmpl_LongVector/tmpl_ULongVector *):                             *
 ...
 *      done with it. This is done with tmpl_Destroy_LongVector and           *
 *      tmpl_Destroy_ULongVector.                                             *
 ******************************************************************************
 *                               DEPENDENCIES                                 *
 ******************************************************************************
...
tmpl_LongVector *tmpl_Create_Zero_LongVector(size_t length)
{
    ...
    vec->data = TMPL_CALLOC(signed long int, length);
    ...
    if (vec->data == NULL)
    {
        ...
        vec->error_message = tmpl_strdup(
            ...
            "\tFunction Name: tmpl_Create_Zero_LongVector\n\n"
...
/*  End of tmpl_Create_Zero_LongVector.                                       */

/*  Function for creating a double-precision zero vector.                     */
tmpl_ULongVector *tmpl_Create_Zero_ULongVector(size_t length)
{
    /*  Declare a variable for the vector pointer we're returning.            */
    ...
    /*  Otherwise, allocate memory for the data pointer. calloc, unlike       *
     *  malloc, will initialize everything to zero, giving us a zero vector.  */
    vec->data = TMPL_CALLOC(unsigned long int, length);
    ...
    if (vec->data == NULL)
    {
        ...
        vec->error_message = tmpl_strdup(
            "Error Encountered: libtmpl\n"
            "\tFunction Name: tmpl_Create_Zero_ULongVector\n\n"
            "Malloc failed and returned NULL for vec->data.\n"
        );
        return vec;
    }
