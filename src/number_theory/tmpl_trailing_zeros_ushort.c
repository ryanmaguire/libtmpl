 ...
 *  Purpose:                                                                  *
 *      Given an unsigned short n, returns the number of trailing zeros for   *
 ...
 *      None.                                                                 *
 *  Method:                                                                   *
 *      If unsigned short is 16 or 32 bit, use a simple O(1) algorithm to     *
...
unsigned int tmpl_UShort_Trailing_Zeros(unsigned short int n)
{
...
/*  End of tmpl_UShort_Trailing_Zeros.                                        */

/*  32-bit is rarer for short.                                                */
...
/*  This is for exotic systems with unsigned short not 16 or 32 bit.          */
#else
