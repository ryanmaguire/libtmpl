 ...
 *  Purpose:                                                                  *
 *      Given a char n, returns the number of trailing zeros for the          *
 ...
 *      C code (this file):                                                   *
 *          tmpl_Char_Trailing_Zeros vs. bfs_func                             *
 *          samples:        10000000                                          *
 *          libtmpl:        0.025666                                          *
 *          glibc:          0.022084                                          *
 ...
 *                                                                            *
 *      x86_64 / amd64 assembly (tmpl_trailing_zeros_char_x86_64.S):          *
 *          tmpl_Char_Trailing_Zeros vs. bfs_func                             *
 *          samples:        10000000                                          *
 *          libtmpl:        0.022505                                          *
 *          glibc:          0.022055                                          *
