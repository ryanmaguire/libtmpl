                                              ...
                                              float lambda)
{
    ...
    float sin_theta, var_1, var_2, var_3, scaled_a, scaled_d, out;

    /*  Compute the length of the point (x, z) in the plane.                  */
    const float norm = tmpl_Float_Hypot(x, z);
    ...
    var_2 = tmpl_Float_SinPi(2.0F*scaled_d*sin_theta);
    var_3 = 2.0F*tmpl_Float_SinPi(scaled_d*sin_theta);
