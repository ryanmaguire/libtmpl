 ...
 ******************************************************************************
 *                  tmpl_two_vector_l2_dist_squared_ldouble                   *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Square of the 2D Euclidean distance. Source:                          *
 *      libtmpl/include/inline/vec2/tmpl_vec2_l2_dist_squared_ldouble.h.      *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 4, 2025                                                   *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_l2_dist_squared_ldouble.h"
