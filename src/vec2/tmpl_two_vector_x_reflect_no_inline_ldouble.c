 ...
 ******************************************************************************
 *                      tmpl_two_vector_x_reflect_ldouble                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Reflection across the x axis.                                         *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_x_reflect_ldouble.h.    *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 29, 2025                                                  *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_x_reflect_ldouble.h"
