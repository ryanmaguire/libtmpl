 ...
 ******************************************************************************
 *                      tmpl_two_vector_normalize_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
...
tmpl_TwoVectorDouble tmpl_2DDouble_Normalize(const tmpl_TwoVectorDouble *P)
{
    tmpl_TwoVectorDouble P_hat;
    const double rcpr_norm = 1.0 / tmpl_2DDouble_L2_Norm(P);
...
/*  End of tmpl_2DDouble_Normalize.                                           */
