 ...
 ******************************************************************************
 *                      tmpl_two_vector_normalize_float                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
tmpl_TwoVectorFloat tmpl_2DFloat_Normalize(const tmpl_TwoVectorFloat *P)
{
    tmpl_TwoVectorFloat P_hat;
    const float rcpr_norm = 1.0F / tmpl_2DFloat_L2_Norm(P);
