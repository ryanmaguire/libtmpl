 ...
 ******************************************************************************
 *                    tmpl_two_vector_dot_product_ldouble                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      2D Euclidean dot product. Source:                                     *
 *      libtmpl/include/inline/vec2/tmpl_two_vector_dot_product_ldouble.h.    *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       March 3, 2021                                                 *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_two_vector_dot_product_ldouble.h"
