 ...
 ******************************************************************************
 *                 tmpl_two_vector_hadamard_productwith_float                 *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      2D Hadamard component-wise product, in-place. Source:                 *
 *      libtmpl/include/inline/vec2/tmpl_vec2_hadamard_productwith_float.h.   *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 9, 2025                                                   *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_hadamard_productwith_float.h"
