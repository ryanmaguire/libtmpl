 ...
 ******************************************************************************
 *                    tmpl_two_vector_cross_product_double                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      2D cross product.                                                     *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_cross_product_double.h. *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 9, 2025                                                   *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_cross_product_double.h"
