 ...
 ******************************************************************************
 *                    tmpl_two_vector_subtractfrom_ldouble                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      2D vector subtraction in-place, -= operator.                          *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_subtractfrom_ldouble.h. *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 13, 2025                                                  *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_subtractfrom_ldouble.h"
