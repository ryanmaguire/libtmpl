 ...
 ******************************************************************************
 *                    tmpl_two_vector_x_projectself_double                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Projection onto the x axis.                                           *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_x_projectself_double.h. *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 13, 2025                                                  *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_x_projectself_double.h"
