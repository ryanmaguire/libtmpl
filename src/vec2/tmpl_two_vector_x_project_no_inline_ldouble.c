 ...
 ******************************************************************************
 *                     tmpl_two_vector_x_project_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Projection onto the x axis.                                           *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_x_project_ldouble.h.    *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 6, 2025                                                   *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_x_project_ldouble.h"
