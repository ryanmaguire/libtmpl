 ...
 ******************************************************************************
 *                    tmpl_two_vector_x_reflectself_double                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Reflection across the x axis.                                         *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_x_reflectself_double.h. *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 29, 2025                                                  *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_x_reflectself_double.h"
