 ...
 ******************************************************************************
 *                    tmpl_two_vector_y_projectself_double                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Projection onto the y axis.                                           *
 *      Source: libtmpl/include/inline/vec2/tmpl_vec2_y_projectself_double.h. *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       May 13, 2025                                                  *
 ******************************************************************************/
...
/*  Implemented here.                                                         */
#include "../../include/inline/vec2/tmpl_vec2_y_projectself_double.h"
