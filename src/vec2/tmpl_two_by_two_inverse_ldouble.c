 ...
 ******************************************************************************
 *                      tmpl_two_by_two_inverse_ldouble                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
tmpl_2x2LDouble_Inverse(const tmpl_TwoByTwoMatrixLongDouble *A)
{
    ...
    tmpl_TwoByTwoMatrixLongDouble InvA;

    /*  Compute the determinant.                                              */
    const long double det = A->dat[0][0]*A->dat[1][1]-A->dat[1][0]*A->dat[0][1];
    const long double det_rcp = 1.0L / det;
...
/*  End of tmpl_2x2LDouble_Inverse.                                           */
