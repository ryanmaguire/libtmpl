 ...
 ******************************************************************************
 *                        tmpl_array_max_float_index                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the max of a float array.                       *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Float_Array_Max_Index                                            *
 *  Purpose:                                                                  *
...
/*  Function for finding the index of the maximum of a float array.           */
size_t tmpl_Float_Array_Max_Index(const float * const arr, const size_t len)
{
...
/*  End of tmpl_Float_Array_Max_Index.                                        */
