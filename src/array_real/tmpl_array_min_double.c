 ...
 ******************************************************************************
 *                           tmpl_array_min_double                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the min of a double array.                                   *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *  Purpose:                                                                  *
 *      Computes min(arr), the minimum of the double array arr.               *
 *  Arguments:                                                                *
 *      arr (double *):                                                       *
 *          An array of doubles.                                              *
 *      len (size_t):                                                         *
...
#ifndef TMPL_DOUBLE_ARRAY_MIN_METHOD
#define TMPL_DOUBLE_ARRAY_MIN_METHOD 1
#endif
...
#if TMPL_DOUBLE_ARRAY_MIN_METHOD == 1

/*  Function for finding the minimum of a double array.                       */
double tmpl_Double_Array_Min(const double * const arr, const size_t len)
{
...
/*  End of tmpl_Double_Array_Min.                                             */

#else
/*  Else for #if TMPL_DOUBLE_ARRAY_MIN_METHOD == 1.                           */
...
#endif
/*  End of #if TMPL_DOUBLE_ARRAY_MIN_METHOD == 1.                             */

/*  The rest of libtmpl does not need this, so undef it.                      */
#undef TMPL_DOUBLE_ARRAY_MIN_METHOD
