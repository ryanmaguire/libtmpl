 ...
 ******************************************************************************
 *                           tmpl_array_max_ldouble                           *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the max of a long double array.                              *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Array_Max                                                *
 *  Purpose:                                                                  *
 *      Computes max(arr), the maximum of the long double array arr.          *
 *  Arguments:                                                                *
 *      arr (long double *):                                                  *
 *          An array of long double.                                          *
 *      len (size_t):                                                         *
 ...
 *      Added alternative method that is surprisingly 1.5x faster.            *
 ******************************************************************************/
...
#ifndef TMPL_LDOUBLE_ARRAY_MAX_METHOD
#define TMPL_LDOUBLE_ARRAY_MAX_METHOD 1
#endif

/*  This method, finding ind and then returning arr[ind], is 1.5x faster.     *
 *  Quite surprising. Tested on an intel x86_64 machine. This method is about *
 *  the same speed as the other on arm64, oddly enough.                       */
#if TMPL_LDOUBLE_ARRAY_MAX_METHOD == 1

/*  Function for finding the maximum of a long double array.                  */
long double
...
/*  End of tmpl_LDouble_Array_Max.                                            */

#else
/*  Else for #if TMPL_LDOUBLE_ARRAY_MAX_METHOD == 1.                          */
...
#endif
/*  End of #if TMPL_LDOUBLE_ARRAY_MAX_METHOD == 1.                            */

/*  The rest of libtmpl does not need this, so undef it.                      */
#undef TMPL_LDOUBLE_ARRAY_MAX_METHOD
