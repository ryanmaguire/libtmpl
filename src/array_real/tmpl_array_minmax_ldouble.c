 ...
 ******************************************************************************
 *                          tmpl_array_minmax_ldouble                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the min and max of a long double array.                      *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Array_MinMax                                             *
 *  Purpose:                                                                  *
 ...
 *  Output:                                                                   *
 *      min (long double *):                                                  *
 *          A pointer to a long double. The min of the array will be here.    *
 *      max (long double *):                                                  *
 *          A pointer to a long double. The max of the array will be here.    *
 *  Called Functions:                                                         *
...
#ifndef TMPL_LDOUBLE_ARRAY_MINMAX_METHOD
#define TMPL_LDOUBLE_ARRAY_MINMAX_METHOD 1
#endif

/*  Alternate method where the indices are found. Slightly faster.            */
#if TMPL_LDOUBLE_ARRAY_MINMAX_METHOD == 1
                          ...
                          long double *min, long double *max)
{
    ...
    while (tmpl_LDouble_Is_NaN(arr[n]))
    {
...
#else
/*  Else for #if TMPL_LDOUBLE_ARRAY_MINMAX_METHOD == 1.                       */
                          ...
                          long double *min, long double *max)
{
    ...
    do {
        ...
        start = arr[n];
        ++n;
    } while (tmpl_LDouble_Is_NaN(start));
