 ...
 ******************************************************************************
 *                       tmpl_array_max_ldouble_index                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the max of a long double array.                 *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Array_Max_Index                                          *
 *  Purpose:                                                                  *
 *      Computes n such that arr[n] >= arr[m] for all other m. The index of   *
 *      the max value of the array. NaN's are skipped.                        *
 *  Arguments:                                                                *
 *      arr (long double *):                                                  *
 ...
 *  Output:                                                                   *
 *      ind (size_t):                                                         *
 *          The index of the maximum of arr.                                  *
 *  Called Functions:                                                         *
...
/*  Function for finding the index of the maximum of a long double array.     */
size_t
...
/*  End of tmpl_LDouble_Array_Max_Index.                                      */
