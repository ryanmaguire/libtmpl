 ...
 ******************************************************************************
 *                           tmpl_array_min_float                             *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the min of a float array.                                    *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Float_Array_Min                                                  *
 *  Purpose:                                                                  *
 *      Computes min(arr), the minimum of the float array arr.                *
 *  Arguments:                                                                *
 *      arr (float *):                                                        *
 *          An array of floats.                                               *
 *      len (size_t):                                                         *
...
#ifndef TMPL_FLOAT_ARRAY_MIN_METHOD
#define TMPL_FLOAT_ARRAY_MIN_METHOD 1
#endif
...
#endif
/*  End of #if TMPL_FLOAT_ARRAY_MIN_METHOD == 1.                              */

/*  The rest of libtmpl does not need this, so undef it.                      */
#undef TMPL_FLOAT_ARRAY_MIN_METHOD
