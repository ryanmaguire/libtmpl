...
/*  Standard 2Prod algorithm for squaring at long double precision.           */
TMPL_ALWAYS_INLINE
void
                        ...
                        long double * TMPL_RESTRICT const err)
{
    ...
    const long double prod_mid = 2.0L * xlo * xhi;
    const long double prod_lo = xlo * xlo;
...
/*  End of tmpl_LDouble_Two_Square.                                           */
