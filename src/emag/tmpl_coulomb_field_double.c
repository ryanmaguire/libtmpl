...
TMPL_UNSEQUENCED
{
    ...
    diff = tmpl_3DDouble_Subtract(observer, &charge->pos);
    ...
    dist = tmpl_3DDouble_L2_Norm(&diff);
    dist_cubed = dist * dist * dist;

    /*  From Coulomb's law the scale is k * q / r^3.                          */
    scale = tmpl_double_coulomb_constant * charge->charge / dist_cubed;
    ...
    return tmpl_3DDouble_Scale(scale, &diff);
}
/*  End of tmpl_3DDouble_Coulomb_Field.                                       */
