 ...
 *      Source: include/inline/complex/tmpl_complex_divide_ldouble.h.         *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       June 5, 2025                                                  *
 ******************************************************************************/
...
tmpl_CLDouble_Divide(tmpl_ComplexLongDouble P, tmpl_ComplexLongDouble Q);

/*  Implemented here.                                                         */
#include "../../include/inline/complex/tmpl_complex_divide_ldouble.h"
