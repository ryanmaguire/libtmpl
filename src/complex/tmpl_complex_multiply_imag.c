...
/*  Single precision complex multiplication where one variable is imaginary.  */
tmpl_ComplexFloat tmpl_CFloat_Multiply_Imag(float y, tmpl_ComplexFloat z)
{
    ...
    /*  The product of iy and a+ib is -yb + i ya.                             */
    prod_re = -y*imag;
    prod_im =  y*real;
...
/*  End of tmpl_CFloat_Multiply_Imag.                                         */

/*  Double precision complex multiplication where one variable is imaginary.  */
tmpl_ComplexDouble tmpl_CDouble_Multiply_Imag(double y, tmpl_ComplexDouble z)
{
    /*  Declare necessary variables. C89 requires declarations at the top.    */
...
/*  Long double precision complex multiplication where one variable is        *
 *  imaginary.                                                                */
