 ...
 ******************************************************************************
 *              tmpl_complex_poly_deriv_deval_real_coeffs_ldouble             *
 ******************************************************************************
 *  Purpose:                                                                  *
                                          ...
                                          tmpl_ComplexLongDouble z)
{
    ...
    if (degree == deriv)
    {
        dpoly.dat[0] = coeffs[degree] * tmpl_LDouble_Factorial(degree);
        dpoly.dat[1] = 0.0L;
        return dpoly;
    }
    ...
    if (deriv == 0U)
        return tmpl_CLDouble_Poly_Eval_Real_Coeffs(coeffs, (size_t)degree, z);
...
/*  End of tmpl_CLDouble_Poly_Deriv_Eval_Real_Coeffs.                         */
