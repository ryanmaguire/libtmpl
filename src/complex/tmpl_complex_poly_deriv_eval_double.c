 ...
 ******************************************************************************
 *                    tmpl_complex_poly_deriv_eval_double                     *
 ******************************************************************************
 *  Purpose:                                                                  *
                             ...
                             tmpl_ComplexDouble z)
{
    ...
    if (degree == deriv)
    {
        factor = tmpl_Double_Factorial(degree);
    ...
    if (deriv == 0U)
        return tmpl_CDouble_Poly_Eval(coeffs, (size_t)degree, z);
...
/*  End of tmpl_CDouble_Poly_Deriv_Eval.                                      */
