                             ...
                             tmpl_ComplexFloat z)
{
    ...
    if (degree == 0)
        return tmpl_CFloat_Rect(coeffs[0], 0.0F);

    /*  Set poly equal to a_{N}*z, where N is the degree of the polynomial.   */
    poly = tmpl_CFloat_Multiply_Real(coeffs[degree], z);

    /*  Reset poly to a_{N}*z + a_{N-1}.                                      */
    poly = tmpl_CFloat_Add_Real(coeffs[degree-1], poly);
    ...
    for (n=2; n<=degree; ++n)
    {
        ...
        poly = tmpl_CFloat_Add_Real(coeffs[degree-n], poly);
    }

    return poly;
}
/*  End of tmpl_CDouble_Poly_Real_Coeffs.                                     */
                              ...
                              tmpl_ComplexDouble z)
{
     ...
     *  zeroth coefficient (a constant polynomial).                           */
    if (degree == 0)
        return tmpl_CDouble_Rect(coeffs[0], 0.0);

    /*  Set poly equal to a_{N}*z, where N is the degree of the polynomial.   */
    poly = tmpl_CDouble_Multiply_Real(coeffs[degree], z);

    /*  Reset poly to a_{N}*z + a_{N-1}.                                      */
    poly = tmpl_CDouble_Add_Real(coeffs[degree-1], poly);
    ...
    for (n=2; n<=degree; ++n)
    {
        ...
        poly = tmpl_CDouble_Add_Real(coeffs[degree-n], poly);
    }
                               ...
                               tmpl_ComplexLongDouble z)
{
     ...
     *  zeroth coefficient (a constant polynomial).                           */
    if (degree == 0)
        return tmpl_CLDouble_Rect(coeffs[0], 0.0L);

    /*  Set poly equal to a_{N}*z, where N is the degree of the polynomial.   */
    poly = tmpl_CLDouble_Multiply_Real(coeffs[degree], z);

    /*  Reset poly to a_{N}*z + a_{N-1}.                                      */
    poly = tmpl_CLDouble_Add_Real(coeffs[degree-1], poly);
    ...
    for (n=2; n<=degree; ++n)
    {
        ...
        poly = tmpl_CLDouble_Add_Real(coeffs[degree-n], poly);
    }
