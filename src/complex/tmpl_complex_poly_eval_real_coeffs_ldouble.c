 ...
 ******************************************************************************
 *                 tmpl_complex_poly_eval_real_coeffs_ldouble                 *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_CLDouble_Poly_Eval_Real_Coeffs                                   *
 *  Purpose:                                                                  *
 *      Evaluates a polynomial with real coefficients at a complex number.    *
 *  Arguments:                                                                *
                                    ...
                                    tmpl_ComplexLongDouble z)
{
    ...
    /*  Set poly equal to a_{N}*z + a_{N-1}, where N is the degree.           */
    poly.dat[0] = coeffs[degree]*z.dat[0] + coeffs[degree-1];
    poly.dat[1] = coeffs[degree]*z.dat[1];
    ...
    for (n = 2; n <= degree; ++n)
    {
        ...
        const long double re = poly.dat[0];

        /*  Compute poly = z*poly + a_{n} using complex multiplication.       */
        poly.dat[0] = z.dat[0]*poly.dat[0] - z.dat[1]*poly.dat[1] + coeffs[ind];
        poly.dat[1] = re*z.dat[1] + poly.dat[1]*z.dat[0];
    }

    return poly;
}
/*  End of tmpl_CLDouble_Poly_Eval_Real_Coeffs.                               */
