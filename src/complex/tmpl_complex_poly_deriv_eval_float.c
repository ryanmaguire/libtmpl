 ...
 ******************************************************************************
 *                     tmpl_complex_poly_deriv_eval_float                     *
 ******************************************************************************
 *  Purpose:                                                                  *
                            ...
                            tmpl_ComplexFloat z)
{
    ...
    if (degree == deriv)
    {
        factor = tmpl_Float_Factorial(degree);
    ...
    if (deriv == 0U)
        return tmpl_CFloat_Poly_Eval(coeffs, (size_t)degree, z);
...
/*  End of tmpl_CFloat_Poly_Deriv_Eval.                                       */
