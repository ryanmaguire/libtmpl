 ...
 ******************************************************************************
 *               tmpl_complex_poly_deriv_deval_real_coeffs_float              *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_CFloat_Poly_Deriv_Eval_Real_Coeffs                               *
 *  Purpose:                                                                  *
                                        ...
                                        tmpl_ComplexFloat z)
{
    ...
    if (degree == deriv)
    {
        dpoly.dat[0] = coeffs[degree] * tmpl_Float_Factorial(degree);
        dpoly.dat[1] = 0.0F;
        return dpoly;
    }
    ...
    if (deriv == 0U)
        return tmpl_CFloat_Poly_Eval_Real_Coeffs(coeffs, (size_t)degree, z);
...
/*  End of tmpl_CFloat_Poly_Deriv_Eval_Real_Coeffs.                           */
