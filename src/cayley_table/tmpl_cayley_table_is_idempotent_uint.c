 ...
 ******************************************************************************
 *                    tmpl_cayley_table_is_idemptotent_uint                   *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *              Check if x * x = x for each x in the set.                     *
 *  Method:                                                                   *
 ...
 *      tmpl_UIntCayleyTable_Is_Idempotent_Kernel, which checks if            *
 *      x * x = x for all x in the set.                                       *
 *  Notes:                                                                    *
...
/*  Checks if a Cayley table corresponds to an idempotent binary operation.   */
tmpl_Bool
tmpl_UIntCayleyTable_Is_Idempotent(const tmpl_UIntCayleyTable * const table)
{
    ...
    if (!table->data)
    {
         ...
         *  working with the empty set. This is an idempotent operation.      */
        if (table->size == 0)
            return tmpl_True;
    ...
    return tmpl_UIntCayleyTable_Is_Idempotent_Kernel(table);
}
/*  End of tmpl_UIntCayleyTable_Is_Idempotent.                                */
