 ...
 ******************************************************************************
 *                    tmpl_cayley_table_right_inverse_uint                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *              Loops through and tries to find a right-inverse for "element".*
 *  Method:                                                                   *
 ...
 *      check for element * x = 0. We return the first "x" that solves this.  *
 *  Notes:                                                                    *
...
/*  Finds a right-inverse for a given element in a Cayley table.              */
unsigned int
                                   ...
                                   const unsigned int element)
{
    ...
    return tmpl_UIntCayleyTable_Right_Inverse_Kernel(table, element);
}
