 ...
 ******************************************************************************
 *                 tmpl_cayley_table_is_self_distributive_uint                *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UIntCayleyTable_Is_Self_Distributive                             *
 *  Purpose:                                                                  *
 ...
 *              Checks if x*(y*z) = (x*y)*(x*z) and (x*y)*z = (x*z)*(y*z) for *
 *              all ordered triples (x, y, z) from the underlying set.        *
 *  Method:                                                                   *
 ...
 *      tmpl_UIntCayleyTable_Is_Self_Distributive_Kernel, which checks if     *
 *      x*(y*z) = (x*y)*(x*z) and (x*y)*z = (x*z)*(y*z) for all ordered       *
 *      triples from the underlying set.                                      *
 *  Notes:                                                                    *
...
)
{
    ...
    if (!table->data)
    {
         ...
         *  the empty set. The operation is self-distributive.                */
        if (table->size == 0)
            return tmpl_True;
     ...
     *  checking for x*(y*z) = (x*y)*(x*z) and (x*y)*z = (x*z)*(y*z).         */
    return tmpl_UIntCayleyTable_Is_Self_Distributive_Kernel(table);
}
/*  End of tmpl_UIntCayleyTable_Is_Self_Distributive.                         */
