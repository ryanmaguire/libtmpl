 ...
 ******************************************************************************
 *                       tmpl_array_minmax_index_llong                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the indices for minimum and maximum of a long long array.    *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LLong_Array_MinMax_Index                                         *
 *  Purpose:                                                                  *
 *      Computes the indices for the min and max of a long long array.        *
 *  Arguments:                                                                *
 *      arr (const signed long long int * const):                             *
 *          A signed long long array.                                         *
 *      len (size_t):                                                         *
...
/*  Function for finding the index of the min and max of a long long array.   */
void
...
/*  End of tmpl_LLong_Array_MinMax_Index.                                     */
