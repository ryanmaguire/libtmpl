 ...
 ******************************************************************************
 *                          tmpl_array_minmax_ushort                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the minimum and maximum of an unsigned short array.          *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UShort_Array_MinMax                                              *
 *  Purpose:                                                                  *
 *      Computes the minimum and maximum of an unsigned short array.          *
 *  Arguments:                                                                *
 ...
 *      min (unsigned short int *):                                           *
 *          A pointer to a unsigned short int. The minimum is stored here.    *
 *      max (unsigned short int *):                                           *
 *          A pointer to a unsigned short int. The maximum is stored here.    *
 *  Output:                                                                   *
 *      None (void).                                                          *
 *  Called Functions:                                                         *
 *      None.                                                                 *
...
/*  Function for finding the min and max of an unsigned short array.          */
void
...
/*  End of tmpl_UShort_Array_MinMax.                                          */
