 ...
 ******************************************************************************
 *                      tmpl_array_ldouble_average_uchar                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the average of an unsigned char array.                       *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UChar_Array_LDouble_Average                                      *
 *  Purpose:                                                                  *
 *      Computes the average of an unsigned char array.                       *
 *  Arguments:                                                                *
...
/*  Function for averaging the elements of an unsigned char array.            */
long double
...
/*  End of tmpl_UChar_Array_LDouble_Average.                                  */
