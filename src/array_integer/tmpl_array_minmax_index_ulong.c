 ...
 ******************************************************************************
 *                       tmpl_array_minmax_index_ulong                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the indices for min and max of an unsigned long array.       *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_ULong_Array_MinMax_Index                                         *
 *  Purpose:                                                                  *
 *      Computes the indices for the min and max of an unsigned long array.   *
 *  Arguments:                                                                *
...
/*  Finds the index of the min and max of an unsigned long array.             */
void
...
/*  End of tmpl_ULong_Array_MinMax_Index.                                     */
