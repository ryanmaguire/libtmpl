 ...
 ******************************************************************************
 *                         tmpl_array_max_index_ulong                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned long array.          *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_ULong_Array_Max_Index                                            *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned long array.          *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the max of an unsigned long int array.  */
size_t
...
/*  End of tmpl_ULong_Array_Max_Index.                                        */
