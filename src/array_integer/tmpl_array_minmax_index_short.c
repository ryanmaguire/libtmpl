 ...
 ******************************************************************************
 *                       tmpl_array_minmax_index_short                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the indices for minimum and maximum of a signed short array. *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Short_Array_MinMax_Index                                         *
 *  Purpose:                                                                  *
 *      Computes the indices for the min and max of a signed short array.     *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the min and max of a short array.       */
void
...
/*  End of tmpl_Short_Array_MinMax_Index.                                     */
