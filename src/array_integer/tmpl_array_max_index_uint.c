 ...
 ******************************************************************************
 *                         tmpl_array_max_index_uint                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned int array.           *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UInt_Array_Max_Index                                             *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned int array.           *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the maximum of an unsigned int array.   */
size_t tmpl_UInt_Array_Max_Index(const unsigned int * const arr, size_t len)
{
...
/*  End of tmpl_UInt_Array_Max_Index.                                         */
