...
/*  Function for finding the index of the max of an unsigned long long array. */
size_t
...
/*  End of tmpl_ULLong_Array_Max_Index.                                       */
