 ...
 ******************************************************************************
 *                     tmpl_array_ldouble_average_ushort                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the average of an unsigned short array.                      *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UShort_Array_LDouble_Average                                     *
 *  Purpose:                                                                  *
 *      Computes the average of an unsigned short array.                      *
 *  Arguments:                                                                *
...
/*  Function for averaging the elements of an unsigned short array.           */
long double
tmpl_UShort_Array_LDouble_Average(const unsigned short int * const arr,
                                  size_t len)
{
...
/*  End of tmpl_UShort_Array_LDouble_Average.                                 */
