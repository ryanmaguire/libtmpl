 ...
 ******************************************************************************
 *                         tmpl_array_min_index_char                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of a signed char array.             *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Char_Array_Min_Index                                             *
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of a signed char array.             *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the minimum of a signed char array.     */
size_t tmpl_Char_Array_Min_Index(const signed char * const arr, size_t len)
{
...
/*  End of tmpl_Char_Array_Min_Index.                                         */
