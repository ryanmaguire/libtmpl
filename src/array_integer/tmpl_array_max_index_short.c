 ...
 ******************************************************************************
 *                         tmpl_array_max_index_short                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of a signed short array.            *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Short_Array_Max_Index                                            *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of a signed short int array.        *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the maximum of a short int array.       */
size_t
...
/*  End of tmpl_Short_Array_Max_Index.                                        */
