 ...
 ******************************************************************************
 *                       tmpl_array_minmax_index_ushort                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the indices for min and max of an unsigned short array.      *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UShort_Array_MinMax_Index                                        *
 *  Purpose:                                                                  *
 *      Computes the indices for the min and max of an unsigned short array.  *
 *  Arguments:                                                                *
...
/*  Finds the index of the min and max of an unsigned short array.            */
void
...
/*  End of tmpl_UShort_Array_MinMax_Index.                                    */
