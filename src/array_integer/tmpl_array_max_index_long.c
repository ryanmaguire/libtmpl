 ...
 ******************************************************************************
 *                         tmpl_array_max_index_long                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of a signed long array.             *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Long_Array_Max_Index                                             *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of a signed long array.             *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the maximum of a long int array.        */
size_t tmpl_Long_Array_Max_Index(const signed long int * const arr, size_t len)
{
...
/*  End of tmpl_Long_Array_Max_Index.                                         */
