...
float tmpl_UInt_Array_Float_Total(const unsigned int * const arr, size_t len)
{
...
/*  End of tmpl_UInt_Array_Float_Total.                                       */
