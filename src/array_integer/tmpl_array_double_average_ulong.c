 ...
 ******************************************************************************
 *                      tmpl_array_double_average_ulong                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_ULong_Array_Double_Average                                       *
 *  Purpose:                                                                  *
 *      Computes the average of an unsigned long array.                       *
 *  Arguments:                                                                *
...
double
tmpl_ULong_Array_Double_Average(const unsigned long int * const arr, size_t len)
{
...
/*  End of tmpl_ULong_Array_Double_Average.                                   */
