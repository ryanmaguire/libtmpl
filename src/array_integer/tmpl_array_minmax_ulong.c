 ...
 ******************************************************************************
 *                          tmpl_array_minmax_ulong                           *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the minimum and maximum of an unsigned long array.           *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_ULong_Array_MinMax                                               *
 *  Purpose:                                                                  *
 *      Computes the minimum and maximum of an unsigned long array.           *
 *  Arguments:                                                                *
 ...
 *          A pointer to an unsigned long int. The minimum is stored here.    *
 *      max (unsigned long int *):                                            *
 *          A pointer to an unsigned long int. The maximum is stored here.    *
 *  Output:                                                                   *
 *      None (void).                                                          *
 *  Called Functions:                                                         *
 *      None.                                                                 *
...
/*  Function for finding the min and max of an unsigned long array.           */
void
...
/*  End of tmpl_ULong_Array_MinMax.                                           */
