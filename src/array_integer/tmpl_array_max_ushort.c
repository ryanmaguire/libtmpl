 ...
 ******************************************************************************
 *                           tmpl_array_max_ushort                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the maximum of an unsigned short array.                      *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UShort_Array_Max                                                 *
 *  Purpose:                                                                  *
 *      Computes the maximum of an unsigned short array.                      *
 *  Arguments:                                                                *
...
/*  Function for finding the maximum of an unsigned short int array.          */
unsigned short int
tmpl_UShort_Array_Max(const unsigned short int * const arr, size_t len)
{
