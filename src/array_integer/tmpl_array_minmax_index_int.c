 ...
 ******************************************************************************
 *                        tmpl_array_minmax_index_int                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the indices for minimum and maximum of a signed int array.   *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Int_Array_MinMax_Index                                           *
 *  Purpose:                                                                  *
 *      Computes the indices for the min and max of a signed int array.       *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the min and max of an int array.        */
void
...
/*  End of tmpl_Int_Array_MinMax_Index.                                       */
