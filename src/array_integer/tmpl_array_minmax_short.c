 ...
 ******************************************************************************
 *                          tmpl_array_minmax_short                           *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the minimum and maximum of a signed short array.             *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Short_Array_MinMax                                               *
 *  Purpose:                                                                  *
 *      Computes the minimum and maximum of a signed short array.             *
 *  Arguments:                                                                *
 *      arr (const signed short int * const):                                 *
 *          A signed short int array.                                         *
 *      len (size_t):                                                         *
 *          The length of the array.                                          *
 *      min (signed short int *):                                             *
 *          A pointer to a signed short int. The minimum is stored here.      *
 *      max (signed short int *):                                             *
 *          A pointer to a signed short int. The maximum is stored here.      *
 *  Output:                                                                   *
 *      None (void).                                                          *
 *  Called Functions:                                                         *
 *      None.                                                                 *
...
/*  Function for finding the min and max of a short array.                    */
void
...
/*  End of tmpl_Short_Array_MinMax.                                           */
