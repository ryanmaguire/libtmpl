 ...
 ******************************************************************************
 *                            tmpl_array_max_uchar                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the maximum of an unsigned char array.                       *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UChar_Array_Max                                                  *
 *  Purpose:                                                                  *
 *      Computes the maximum of an unsigned char array.                       *
 *  Arguments:                                                                *
...
/*  Function for finding the maximum of an unsigned char array.               */
unsigned char tmpl_UChar_Array_Max(const unsigned char * const arr, size_t len)
{
