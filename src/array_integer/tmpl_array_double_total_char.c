...
double tmpl_Char_Array_Double_Total(const signed char * const arr, size_t len)
{
...
/*  End of tmpl_Char_Array_Double_Total.                                      */
