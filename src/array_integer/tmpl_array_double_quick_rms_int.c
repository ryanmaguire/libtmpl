 ...
 ******************************************************************************
 *                         tmpl_array_double_rms_int                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the root-mean-square of a signed int array.                  *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
...
/*  Computes the root-mean-square of a signed int array.                      */
double tmpl_Int_Array_Double_Quick_RMS(const signed int * const arr, size_t len)
{
    ...
    return tmpl_Double_Sqrt((double)sum / (double)len);
}
/*  End of tmpl_Int_Array_Double_Quick_RMS.                                   */
