 ...
 ******************************************************************************
 *                         tmpl_array_min_index_long                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of a signed long array.             *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Long_Array_Min_Index                                             *
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of a signed long array.             *
 *  Arguments:                                                                *
...
size_t tmpl_Long_Array_Min_Index(const signed long int * const arr, size_t len)
{
...
/*  End of tmpl_Long_Array_Min_Index.                                         */
