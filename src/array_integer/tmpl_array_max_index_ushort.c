 ...
 ******************************************************************************
 *                        tmpl_array_max_index_ushort                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned short array.         *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UShort_Array_Max_Index                                           *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned short int array.     *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the maximum of an unsigned short array. */
size_t
tmpl_UShort_Array_Max_Index(const unsigned short int * const arr, size_t len)
{
    ...
    for (n = 1; n < len; ++n)
    {
        /*  If the current array element is greater, reset the index.         */
        if (arr[n] > arr[ind])
            ind = n;
    }
...
/*  End of tmpl_UShort_Array_Max_Index.                                       */
