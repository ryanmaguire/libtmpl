 ...
 ******************************************************************************
 *                            tmpl_array_min_short                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the minimum of a signed short array.                         *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Short_Array_Min                                                  *
 *  Purpose:                                                                  *
 *      Computes the minimum of a signed short array.                         *
 *  Arguments:                                                                *
...
/*  Function for finding the minimum of a short int array.                    */
signed short int
