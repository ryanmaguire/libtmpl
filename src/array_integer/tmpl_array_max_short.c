 ...
 ******************************************************************************
 *                            tmpl_array_max_short                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the maximum of a signed short array.                         *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Short_Array_Max                                                  *
 *  Purpose:                                                                  *
 *      Computes the maximum of a signed short array.                         *
 *  Arguments:                                                                *
...
/*  Function for finding the maximum of a short int array.                    */
signed short int
