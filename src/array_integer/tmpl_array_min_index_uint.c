...
/*  Function for finding the index of the minimum of an unsigned int array.   */
size_t tmpl_UInt_Array_Min_Index(const unsigned int * const arr, size_t len)
{
...
/*  End of tmpl_UInt_Array_Min_Index.                                         */
