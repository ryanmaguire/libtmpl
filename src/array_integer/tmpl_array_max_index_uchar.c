 ...
 ******************************************************************************
 *                         tmpl_array_max_index_uchar                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned char array.          *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UChar_Array_Max_Index                                            *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of an unsigned char array.          *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the maximum of an unsigned char array.  */
size_t tmpl_UChar_Array_Max_Index(const unsigned char * const arr, size_t len)
{
...
/*  End of tmpl_UChar_Array_Max_Index.                                        */
