 ...
 ******************************************************************************
 *                        tmpl_array_min_index_ullong                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of an unsigned long long array.     *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_ULLong_Array_Min_Index                                           *
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of an unsigned long long array.     *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the min of an unsigned long long array. */
size_t
...
/*  End of tmpl_ULLong_Array_Min_Index.                                       */
