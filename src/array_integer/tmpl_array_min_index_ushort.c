 ...
 ******************************************************************************
 *                        tmpl_array_min_index_ushort                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of an unsigned short array.         *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_UShort_Array_Min_Index                                           *
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of an unsigned short int array.     *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the minimum of an unsigned short array. */
size_t
tmpl_UShort_Array_Min_Index(const unsigned short int * const arr, size_t len)
{
...
/*  End of tmpl_UShort_Array_Min_Index.                                       */
