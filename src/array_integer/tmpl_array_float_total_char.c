...
float tmpl_Char_Array_Float_Total(const signed char * const arr, size_t len)
{
...
/*  End of tmpl_Char_Array_Float_Total.                                       */
