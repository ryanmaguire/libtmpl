...
float tmpl_Long_Array_Float_Total(const signed long int * const arr, size_t len)
{
...
/*  End of tmpl_Long_Array_Float_Total.                                       */
