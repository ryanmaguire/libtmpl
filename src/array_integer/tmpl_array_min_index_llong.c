 ...
 ******************************************************************************
 *                         tmpl_array_min_index_llong                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of a signed long long array.        *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LLong_Array_Min_Index                                            *
 *  Purpose:                                                                  *
 *      Computes the index of the minimum of a signed long long array.        *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the minimum of a long long array.       */
size_t
...
/*  End of tmpl_LLong_Array_Min_Index.                                        */
