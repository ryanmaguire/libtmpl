 ...
 ******************************************************************************
 *                      tmpl_array_ldouble_average_long                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the average of a signed long array.                          *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Long_Array_LDouble_Average                                       *
 *  Purpose:                                                                  *
 *      Computes the average of a signed long array.                          *
 *  Arguments:                                                                *
...
/*  Function for averaging the elements of a signed long array.               */
long double
...
/*  End of tmpl_Long_Array_LDouble_Average.                                   */
