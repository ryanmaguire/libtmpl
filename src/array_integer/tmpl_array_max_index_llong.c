 ...
 ******************************************************************************
 *                         tmpl_array_max_index_llong                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of a signed long long array.        *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LLong_Array_Max_Index                                            *
 *  Purpose:                                                                  *
 *      Computes the index of the maximum of a signed long long array.        *
 *  Arguments:                                                                *
...
/*  Function for finding the index of the maximum of a long long array.       */
size_t
...
/*  End of tmpl_LLong_Array_Max_Index.                                        */
