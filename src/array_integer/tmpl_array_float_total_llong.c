...
float
tmpl_LLong_Array_Float_Total(const signed long long int * const arr, size_t len)
{
...
/*  End of tmpl_LLong_Array_Float_Total.                                      */
