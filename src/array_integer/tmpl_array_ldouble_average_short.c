 ...
 ******************************************************************************
 *                      tmpl_array_ldouble_average_short                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the average of a signed short array.                         *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Short_Array_LDouble_Average                                      *
 *  Purpose:                                                                  *
 *      Computes the average of a signed short array.                         *
 *  Arguments:                                                                *
...
/*  Function for averaging the elements of a signed short array.              */
long double
...
/*  End of tmpl_Short_Array_LDouble_Average.                                  */
