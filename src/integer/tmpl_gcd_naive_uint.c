 ...
 *      better to use the binary GCD (tmpl_UInt_GCD) which runs in O(log(n)). *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_integer.h:                                                       *
...
unsigned int tmpl_UInt_GCD_Naive(unsigned int m, unsigned int n)
{
