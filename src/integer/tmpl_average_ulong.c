 ...
 *      tmpl_ULong_Average                                                    *
 *  Purpose:                                                                  *
 *      Computes the average, rounded down, of two unsigned long ints.        *
 *  Arguments:                                                                *
...
/*  Function for averaging two unsigned long ints, rounded down.              */
TMPL_CONST_FUNC
unsigned long int
