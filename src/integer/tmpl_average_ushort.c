 ...
 *      tmpl_UShort_Average                                                   *
 *  Purpose:                                                                  *
 *      Computes the average, rounded down, of two unsigned short ints.       *
 *  Arguments:                                                                *
 *      m (const unsigned short int):                                         *
 *          An integer.                                                       *
 *      n (const unsigned short int):                                         *
 *          Another integer.                                                  *
 *  Output:                                                                   *
 *      avg (unsigned short int):                                             *
...
/*  Function for averaging two unsigned short ints, rounded down.             */
TMPL_CONST_FUNC
unsigned short int
