...
/*  For n > 8, and for 16-bit unsigned short, n! overflows. Pre-compute the   *
...
/*  For n > 12, and for 32-bit unsigned short, n! overflows. Pre-compute the  *
...
/*  For n > 20, and for 64-bit unsigned short, n! overflows. Pre-compute the  *
