 ...
 *      None.                                                                 *
 *  Method:                                                                   *
 *      If unsigned short is 16, 32, or 64 bit, use an O(1) algorithm to      *
...
int tmpl_UShort_Trailing_Zeros(unsigned short int n)
{
...
/*  Essentially unheard of, 32-bit short.                                     */
