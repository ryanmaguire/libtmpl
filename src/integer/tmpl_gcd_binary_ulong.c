 ...
 *              Counts the number of trailing zeros in an unsigned long. On   *
 *              platforms supporting ctzl or bsfl this macro expands to one   *
 *              of those, otherwise it is tmpl_ULong_Trailing_Zeros.          *
 *  Method:                                                                   *
 ...
 *          factor of 2. The tmpl_ULong_GCD function selects the algorithm    *
 ...
 *  Error:                                                                    *
 *      Based on 1,122,664,311 samples with 0 <= x, y < RAND_MAX.             *
...
/*  Function prototype is found here, as is TMPL_ULONG_TRAILING_ZEROS.        */
...
tmpl_ULong_GCD_Binary(const unsigned long int m, const unsigned long int n)
{
     ...
     *  of bits in unsigned long, or it may be something else. This if-then   *
