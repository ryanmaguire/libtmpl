 ...
 *  Purpose:                                                                  *
 *      Given an unsigned int n, returns the number of trailing zeros for     *
 ...
 *      None.                                                                 *
 *  Method:                                                                   *
 *      If unsigned int is 16, 32, or 64 bit, use an O(1) algorithm to        *
...
int tmpl_ULong_Trailing_Zeros(unsigned long int n)
{
...
/*  End of tmpl_ULong_Trailing_Zeros.                                         */
