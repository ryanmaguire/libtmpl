 ...
 ******************************************************************************
 *          tmpl_ideal_stationary_cyl_fresnel_phi_newton_deg_ldouble          *
 ******************************************************************************
 *  Purpose:                                                                  *
                                                         ...
                                                         unsigned int max_iters)
{
    ...
    long double xi, eta, psi0, dxi, deta, deta2, dxi2;
    long double rcpr_psi0, rcpr_psi0_cubed;
    long double cos_phi, sin_phi, cos_phi0, sin_phi0;
    long double cos_phi_phi0, sin_phi_phi0;
    long double dpsi, d2psi, err, num_factor;

    /*  Index for keeping track of the number of iterations.                  */
    unsigned int n = 0U;

    /*  The functions tmpl_LDouble_Ideal_Cyl_Fresnel_d2Psi_dPhi2 and          *
     *  tmpl_LDouble_Ideal_Cyl_Fresnel_dPsi_dPhi do a lot of the same         *
    ...
    do {
        ...
        dpsi = 0.5L * rcpr_psi0 * num_factor + dxi;
        ...
        d2psi = -0.25L * rcpr_psi0_cubed * num_factor * num_factor;
        d2psi += 0.5L * rcpr_psi0 * (deta2 - 2.0L * dxi2) + dxi2;
        ...
        err = tmpl_LDouble_Abs(dpsi);

    } while (err > eps);

    return phi;
}
/*  End of tmpl_LDouble_Ideal_Stationary_Cyl_Fresnel_Phi_Newton_Deg.          */
