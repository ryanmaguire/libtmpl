 ...
 ******************************************************************************
 *                    tmpl_cyl_fresnel_scale_deg_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
                                   ...
                                   long double phi, long double B)
{
    ...
    const long double sin_phi = tmpl_LDouble_Sind(phi);

    /*  Compute cos(B) and sin(B) simultaneously with SinCos.                 */
    tmpl_LDouble_SinCosd(B, &sin_B, &cos_B);
...
/*  End of tmpl_LDouble_Cyl_Fresnel_Scale_Deg.                                */
