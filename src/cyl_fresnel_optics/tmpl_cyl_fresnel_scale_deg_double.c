 ...
 ******************************************************************************
 *                     tmpl_cyl_fresnel_scale_deg_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *  Called Functions:                                                         *
 *      tmpl_Double_Sind (tmpl_math.h):                                       *
 *          Computes sine, in degrees.                                        *
 *      tmpl_Double_SinCosd (tmpl_math.h):                                    *
 ...
 *      Created file, edited from radians version.                            *
 ******************************************************************************/
...
double
tmpl_Double_Cyl_Fresnel_Scale_Deg(double lambda, double D, double phi, double B)
{
    ...
    const double sin_phi = tmpl_Double_Sind(phi);

    /*  Compute cos(B) and sin(B) simultaneously with SinCosd.                */
    tmpl_Double_SinCosd(B, &sin_B, &cos_B);
...
/*  End of tmpl_Double_Cyl_Fresnel_Scale_Deg.                                 */
