...
)
{
    ...
    const float rcpr_rho_dist = 1.0F / rho_dist;
    const float rcpr_rho_dist_sq = rcpr_rho_dist * rcpr_rho_dist;
...
/*  End of tmpl_Float_Cyl_Fresnel_d2Psi_dPhi2.                                */
