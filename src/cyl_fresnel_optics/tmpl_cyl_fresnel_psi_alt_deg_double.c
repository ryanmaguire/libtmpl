 ...
 ******************************************************************************
 *                    tmpl_cyl_fresnel_psi_alt_deg_double                     *
 ******************************************************************************
 *  Purpose:                                                                  *
                                    ...
                                    double phi0, double B, double D)
{
    ...
    const double cos_phi = tmpl_Double_Cosd(phi);
    const double cos_phi0 = tmpl_Double_Cosd(phi0);
    const double cos_phi_phi0 = tmpl_Double_Cosd(phi - phi0);
...
/*  End of tmpl_Double_Cyl_Fresnel_Psi_Alt_Deg.                               */
