 ...
 ******************************************************************************
 *                  tmpl_cyl_fresnel_dpsi_dphi_d_deg_double                   *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the first partial derivative of the Cylindrical Fresnel      *
 *      kernel with respect to phi at double precision. The distance D from   *
                                        ...
                                        double rx, double ry, double rz)
{
    ...
    double xi, eta, psi0, dxi, deta, rcpr_D, rcpr_D_squared;
    double cos_phi, sin_phi, cos_phi0, sin_phi0, cos_phi_phi0, sin_phi_phi0;
    double dpsi, dD, D, dx, dy, xi_factor, eta_factor;
...
/*  End of tmpl_Double_Cyl_Fresnel_dPsi_dPhi_D_Deg.                           */
