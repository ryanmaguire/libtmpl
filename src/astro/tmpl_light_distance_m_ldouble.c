...
TMPL_UNSEQUENCED
{
    return tmpl_ldouble_speed_of_light_mps * tmpl_LDouble_Dist(t0, t1);
}
/*  End tmpl_LDouble_Light_Distance_M.                                        */
