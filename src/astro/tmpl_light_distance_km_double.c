...
TMPL_CONST_FUNC
TMPL_ALWAYS_INLINE
double tmpl_Double_Light_Distance_KM(const double t0, const double t1)
TMPL_UNSEQUENCED
{
    return tmpl_double_speed_of_light_kmps * tmpl_Double_Dist(t0, t1);
}
/*  End tmpl_Double_Light_Distance_KM.                                        */
