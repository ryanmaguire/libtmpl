 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Light_Distance                                           *
 *  Purpose:                                                                  *
 *      Computes the distance traveled by light in a vacuum.                  *
 *  Arguments:                                                                *
 *      t0 (const long double):                                               *
 *          The start time, in seconds.                                       *
 *      t1 (const long double):                                               *
...
/*  The speed of light, in kilometers per second, as a long double.           */
#define TMPL_SPEED_OF_LIGHT_KILOMETERS_PER_SECOND (299792.4580L)
...
{
    return TMPL_SPEED_OF_LIGHT_KILOMETERS_PER_SECOND*tmpl_LDouble_Dist(t0, t1);
}
/*  End tmpl_LDouble_Light_Distance.                                          */
