 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Float_Mean_Longitude                                             *
 *  Purpose:                                                                  *
 *      Computes mean longitude from mean angular motion.                     *
 *  Arguments:                                                                *
 *      epoch_mean_longitude (const float):                                   *
 *          The initial mean longitude at a given epoch.                      *
 *      mean_motion (const float):                                            *
