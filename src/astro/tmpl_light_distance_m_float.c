...
TMPL_CONST_FUNC
TMPL_ALWAYS_INLINE
float tmpl_Float_Light_Distance_M(const float t0, const float t1)
TMPL_UNSEQUENCED
{
    return tmpl_float_speed_of_light_mps * tmpl_Float_Dist(t0, t1);
}
/*  End tmpl_Float_Light_Distance_M.                                          */
