...
double tmpl_Double_LambertW(double x)
{
    ...
    else if (w.bits.sign)
    {
        ...
        w.r = x + tmpl_Double_Rcpr_Euler_E;
...
double tmpl_Double_LambertW(double x)
{
    ...
    else if (w.bits.sign)
    {
        ...
        x0 = tmpl_Double_Sqrt(2.0*tmpl_Double_Euler_E*w.r);
        w.r = x + 1.0;
    }
...
double tmpl_Double_LambertW(double x)
{
    ...
    else if (x < 0.0)
    {
        ...
        x0 = tmpl_Double_Sqrt(2.0*tmpl_Double_Euler_E*y);
        y = x + 1.0;
    }
