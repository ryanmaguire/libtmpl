...
#include "auxiliary/tmpl_lambertw_maclaurin_ldouble.h"
#include "auxiliary/tmpl_lambertw_near_branch_ldouble.h"
#include "auxiliary/tmpl_lambertw_pade_ldouble.h"
#include "auxiliary/tmpl_lambertw_halley_ldouble.h"
