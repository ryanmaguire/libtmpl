...
#define A11 (+5.513358961220205856079701334238E+02)
#define A12 (+3.038090510922384268610585422720E+03)
#define A13 (+1.825775547429317469116938355000E+04)
#define A14 (+1.188384262567832531237721482852E+05)
...
double tmpl_Double_Bessel_I0_Small_Asymptotic(double x)
{
