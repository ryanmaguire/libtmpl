 ...
 ******************************************************************************
 *             tmpl_normalized_fresnel_sin_auxiliary_small_float              *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_NORMALIZED_FRESNEL_SIN_AUXILIARY_SMALL_FLOAT_H
#define TMPL_NORMALIZED_FRESNEL_SIN_AUXILIARY_SMALL_FLOAT_H
...
TMPL_CONST_FUNC
TMPL_STATIC_INLINE
float tmpl_Float_Normalized_Fresnel_Sin_Auxiliary_Small(const float x)
TMPL_UNSEQUENCED
{
