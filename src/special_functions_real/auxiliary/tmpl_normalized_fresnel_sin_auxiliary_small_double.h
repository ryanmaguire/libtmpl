 ...
 ******************************************************************************
 *             tmpl_normalized_fresnel_sin_auxiliary_small_double             *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_NORMALIZED_FRESNEL_SIN_AUXILIARY_SMALL_DOUBLE_H
#define TMPL_NORMALIZED_FRESNEL_SIN_AUXILIARY_SMALL_DOUBLE_H
...
TMPL_CONST_FUNC
TMPL_STATIC_INLINE
double tmpl_Double_Normalized_Fresnel_Sin_Auxiliary_Small(const double x)
TMPL_UNSEQUENCED
{
    ...
    return 0.5 - (f * cos_x + g * sin_x);
}
/*  End of tmpl_Double_Normalized_Fresnel_Sin_Auxiliary_Small.                */
