 ...
 ******************************************************************************
 *               tmpl_float_normalized_fresnel_sin_remez_float                *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_NORMALIZED_FRESNEL_SIN_REMEZ_FLOAT_H
#define TMPL_NORMALIZED_FRESNEL_SIN_REMEZ_FLOAT_H
...
float tmpl_Float_Normalized_Fresnel_Sin_Remez(tmpl_IEEE754_Float w)
{
     ...
     *  1/32. 0x7FFC0000, in hexadecimal, is the bit-mask for this.           */
...
/*  End of tmpl_Float_Normalized_Fresnel_Sin_Remez.                           */
...
/*  Computes C(x) using Remez polynomials and a lookup table.                 */
TMPL_STATIC_INLINE
float tmpl_Float_Normalized_Fresnel_Sin_Remez(float x)
{
