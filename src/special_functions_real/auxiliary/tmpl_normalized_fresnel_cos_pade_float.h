 ...
 ******************************************************************************
 *                   tmpl_normalized_fresnel_cos_pade_float                   *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_NORMALIZED_FRESNEL_COS_PADE_FLOAT_H
#define TMPL_NORMALIZED_FRESNEL_COS_PADE_FLOAT_H
...
/*  End of tmpl_Float_Normalized_Fresnel_Cos_Pade.                            */
