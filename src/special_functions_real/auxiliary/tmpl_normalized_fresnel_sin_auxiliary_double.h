 ...
 ******************************************************************************
 *                tmpl_normalized_fresnel_sin_auxiliary_double                *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_NORMALIZED_FRESNEL_SIN_AUXILIARY_DOUBLE_H
#define TMPL_NORMALIZED_FRESNEL_SIN_AUXILIARY_DOUBLE_H
...
TMPL_STATIC_INLINE
double tmpl_Double_Normalized_Fresnel_Sin_Auxiliary(const double x)
{
...
/*  End of tmpl_Double_Normalized_Fresnel_Sin_Auxiliary.                      */
