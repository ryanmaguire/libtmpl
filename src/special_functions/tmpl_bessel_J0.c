...
float tmpl_Float_Bessel_J0(float x)
{
    ...
    if (arg < 4.0F)
        bessel_J0 = tmpl_Real_Poly_Float_Coeffs(taylorf, 7U, arg);
    else if (arg < 16.0F)
        bessel_J0 = tmpl_Real_Poly_Float_Coeffs(taylorf, 10U, arg);
    else if (arg < 25.0F)
        bessel_J0 = tmpl_Real_Poly_Float_Coeffs(taylorf, 12U, arg);
    else if (arg < 36.0F)
        bessel_J0 = tmpl_Real_Poly_Float_Coeffs(taylorf, 13U, arg);
    else if (arg < 49.0F)
        bessel_J0 = tmpl_Real_Poly_Float_Coeffs(taylorf, 15U, arg);
    else if (arg < 64.0F)
        bessel_J0 = tmpl_Real_Poly_Float_Coeffs(taylorf, 16U, arg);
...
double tmpl_Double_Bessel_J0(double x)
{
    ...
    /*  For small arguments, use the Taylor series of J_0.                    */
    if (arg < 4.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 12U, arg);
    else if (arg < 16.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 16U, arg);
    else if (arg < 25.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 18U, arg);
    else if (arg < 36.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 19U, arg);
    else if (arg < 49.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 21U, arg);
    else if (arg < 64.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 23U, arg);
    else if (arg < 81.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 24U, arg);
    else if (arg < 100.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 26U, arg);
    else if (arg < 121.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 27U, arg);
    else if (arg < 144.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 29U, arg);
    else if (arg < 196.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 30U, arg);
    else if (arg < 225.0)
        bessel_J0 = tmpl_Real_Poly_Double_Coeffs(taylor, 31U, arg);
...
long double tmpl_LDouble_Bessel_J0(long double x)
{
    ...
    /*  For small arguments, use the Taylor series of J_0.                    */
    if (arg < 4.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 12U, arg);
    else if (arg < 16.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 16U, arg);
    else if (arg < 25.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 18U, arg);
    else if (arg < 36.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 19U, arg);
    else if (arg < 49.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 21U, arg);
    else if (arg < 64.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 23U, arg);
    else if (arg < 81.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 24U, arg);
    else if (arg < 100.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 26U, arg);
    else if (arg < 121.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 27U, arg);
    else if (arg < 144.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 29U, arg);
    else if (arg < 169.0L)
        bessel_J0 = tmpl_Real_Poly_LDouble_Coeffs(taylorl, 30U, arg);
