...
void tmpl_Legendre_Polynomials(double *legendre_p, double x, int order)
{
    int i;
    legendre_p[0] = 1.0;
    legendre_p[1] = x;
...
void tmpl_Alt_Legendre_Polynomials(double *poly,
...
void tmpl_Fresnel_Kernel_Coefficients(double *fresnel_ker_coeffs,
                                             double *legendre_p,
