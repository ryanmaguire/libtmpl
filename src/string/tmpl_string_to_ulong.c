 ...
 *          the number of bits in unsigned long int (usually 32 or 64).       *
 *      5.) It is assumed the string ends with a null terminator.             *
 *      6.) If the input is NULL, then zero will be returned.                 *
 *      7.) If the input is larger than the width of unsigned long int, then  *
 *          the output will be reduced mod 2^N where N is the width of        *
 *          unsigned long int (which is usually 32 or 64 bits).               *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_config.h:                                                        *
...
/*  Converts a string to an unsigned long int.                                */
unsigned long int tmpl_String_To_ULong(const char *str)
{
