 ...
 ******************************************************************************
 *                           tmpl_string_to_ullong                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Converts a string to an unsigned long long int.                       *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *          the number of bits in unsigned long long int (usually 64).        *
 *      5.) It is assumed the string ends with a null terminator.             *
 *      6.) If the input is NULL, then zero will be returned.                 *
 *      7.) If the input is larger than the width of unsigned long long int,  *
 *          then the output will be reduced mod 2^N where N is the width of   *
 *          unsigned long long int (which is usually 64 bits).                *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_inttype.h:                                                       *
 *          Header file where TMPL_HAS_LONGLONG is defined.                   *
 *  2.) tmpl_config.h:                                                        *
...
/*  Older compilers do not support long long, and on some systems long long   *
 *  and long are the same type, so support may not be requested. Check this.  */
...
/*  Converts a string to an unsigned long long int.                           */
unsigned long long int tmpl_String_To_ULLong(const char *str)
{
    ...
    const unsigned long long int ten = 10ULL;
    ...
    unsigned long long int out = 0ULL;
     ...
     *  is the number of bits in unsigned long long int (usually 64). We      *
    ...
    while (*str)
    {
        ...
        const unsigned long long int digit =
            TMPL_CAST(*str - '0', unsigned long long int);
         ...
         *  we cast digit to unsigned long long int, this is equivalent to    *
     ...
     *  number of bits in unsigned long long int.                             */
    if (sign)
        return -out;
...
/*  tmpl_Char_Is_Digit and tmpl_Char_To_ULLong provided here.                 */
