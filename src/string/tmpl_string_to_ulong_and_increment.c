 ...
 ******************************************************************************
 *                     tmpl_string_to_ulong_and_increment                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Converts a string to an unsigned long and increments the char pointer *
...
/*  Converts a string to an unsigned long int and increments the pointer.     */
unsigned long int
tmpl_String_To_ULong_And_Increment(const char ** const str_ptr)
{
    ...
    const unsigned long int ten = 10UL;
     ...
     *  is the number of bits in unsigned long (usually 32 or 64). We         *
     *  initialize sign to positive, but we'll check later for a minus sign.  */
    ...
    /*  The bulk of the function is the same as tmpl_String_To_ULong, except  *
    ...
    while (*str)
    {
        ...
        const unsigned long int digit =
            TMPL_CAST(*str - '0', unsigned long int);
         ...
         *  we cast digit to unsigned long int, this is equivalent to         *
...
/*  End of tmpl_String_To_ULong_And_Increment.                                */
...
/*  tmpl_Char_Is_Digit and tmpl_Char_To_ULong provided here.                  */
