 ...
 ******************************************************************************
 *                         tmpl_destroy_polynomial_q                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for safely free'ing all of the memory in a tmpl_PolynomialQ      *
 *      pointer and then setting the pointers to NULL.                        *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Destroy_PolynomialQ                                              *
 *  Purpose:                                                                  *
 *      Free all of the memory in a polynomial pointer.                       *
 *  Arguments:                                                                *
 *      poly_ptr (tmpl_PolynomialQ **):                                       *
...
void tmpl_Destroy_PolynomialQ(tmpl_PolynomialQ **poly_ptr)
{
...
/*  End of tmpl_Destroy_PolynomialQ.                                          */
