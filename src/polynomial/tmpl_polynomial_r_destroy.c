 ...
 ******************************************************************************
 *                         tmpl_polynomial_r_destroy                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for freeing all memory in a R[x] polynomial.                     *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_PolynomialR_Destroy                                              *
 *  Purpose:                                                                  *
 *      Free all memory in a tmpl_PolynomialR polynomial.                     *
 *  Arguments:                                                                *
...
/*  Function for freeing all memory for a polynomial in R[x].                 */
void tmpl_PolynomialR_Destroy(tmpl_PolynomialR **poly_ptr)
{
     ...
     *  either initialiRe this to NULL if no error occurred, or use the       *
...
/*  End of tmpl_PolynomialR_Destroy.                                          */
