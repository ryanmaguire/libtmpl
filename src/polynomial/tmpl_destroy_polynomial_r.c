 ...
 ******************************************************************************
 *                         tmpl_destroy_polynomial_r                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for safely free'ing all of the memory in a tmpl_PolynomialR      *
 *      pointer and then setting the pointers to NULL.                        *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Destroy_PolynomialR                                              *
 *  Purpose:                                                                  *
 *      Free all of the memory in a polynomial pointer.                       *
 *  Arguments:                                                                *
 *      poly_ptr (tmpl_PolynomialR **):                                       *
...
void tmpl_Destroy_PolynomialR(tmpl_PolynomialR **poly_ptr)
{
...
/*  End of tmpl_Destroy_PolynomialR.                                          */
