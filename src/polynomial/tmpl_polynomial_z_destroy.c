 ...
 ******************************************************************************
 *                         tmpl_polynomial_z_destroy                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for freeing all memory in a Z[x] polynomial.                     *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_PolynomialZ_Destroy                                              *
 *  Purpose:                                                                  *
 *      Free all memory in a tmpl_PolynomialZ polynomial.                     *
 *  Arguments:                                                                *
...
/*  Function for freeing all memory for a polynomial in Z[x].                 */
void tmpl_PolynomialZ_Destroy(tmpl_PolynomialZ **poly_ptr)
{
...
/*  End of tmpl_PolynomialZ_Destroy.                                          */
