 ...
 ******************************************************************************
 *                         tmpl_destroy_polynomial_c                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for safely free'ing all of the memory in a tmpl_PolynomialC      *
 *      pointer and then setting the pointers to NULL.                        *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Destroy_PolynomialC                                              *
 *  Purpose:                                                                  *
 *      Free all of the memory in a polynomial pointer.                       *
 *  Arguments:                                                                *
 *      poly_ptr (tmpl_PolynomialC **):                                       *
...
void tmpl_Destroy_PolynomialC(tmpl_PolynomialC **poly_ptr)
{
...
/*  End of tmpl_Destroy_PolynomialC.                                          */
