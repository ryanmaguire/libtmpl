 ...
 ******************************************************************************
 *                          tmpl_polynomial_r_calloc                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for creating a polynomial in R[x] with coeffs pointer allocated  *
...
tmpl_PolynomialR *tmpl_PolynomialR_Calloc(unsigned long int number_of_coeffs)
{
