 ...
 ******************************************************************************
 *                       tmpl_create_zero_polynomial_c                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for creating a degree N polynomial in C[z] with all coefficients *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Create_Zero_PolynomialC                                          *
 *  Purpose:                                                                  *
 *      Creates a polynomial in C[z] with all coefficients set to zero.       *
 *  Arguments:                                                                *
 ...
 *  3.) tmpl_complex.h:                                                       *
 *          Header file for working with complex numbers.                     *
 *  4.) tmpl_polynomial.h:                                                    *
...
tmpl_PolynomialC *tmpl_Create_Zero_PolynomialC(unsigned long int degree)
{
    ...
    if (poly->coeffs == NULL)
    {
        ...
        poly->error_message = tmpl_strdup(
            ...
            "\r\ttmpl_Create_Zero_PolynomialC\n\n"
    ...
    else
    {
        ...
        for (n = 0UL; n <= degree; ++n)
            poly->coeffs[n] = tmpl_CDouble_Zero;
...
/*  End of tmpl_Create_Zero_PolynomialC.                                      */
