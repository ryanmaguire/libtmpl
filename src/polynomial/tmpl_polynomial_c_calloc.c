 ...
 ******************************************************************************
 *                          tmpl_polynomial_c_calloc                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for creating a polynomial in C[x] with coeffs pointer allocated  *
 ...
 *  Purpose:                                                                  *
 *      Creates a polynomial in C[x] with all coefficients set to zero.       *
 *  Arguments:                                                                *
...
tmpl_PolynomialC *tmpl_PolynomialC_Calloc(unsigned long int number_of_coeffs)
{
