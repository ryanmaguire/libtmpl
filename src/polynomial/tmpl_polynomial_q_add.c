 ...
 ******************************************************************************
 *                          tmpl_polynomials_q_add                            *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for adding two elements of Q[x].                                 *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_PolynomialQ_Add                                                  *
 *  Purpose:                                                                  *
 *      Add two polynomials in Q[x].                                          *
 *  Arguments:                                                                *
 *      P (tmpl_PolynomialQ *):                                               *
 *          A pointer to the first polynomial.                                *
 *      Q (tmpl_PolynomialQ *):                                               *
 *          A pointer to the second polynomial.                               *
 *      sum (tmpl_PolynomialQ *):                                             *
...
/*  Function for adding two polynomials in Q[x].                              */
void
                     ...
                     tmpl_PolynomialQ *sum)
{
    ...
    for (n = 0UL; n <= first->degree; ++n)
        sum->coeffs[n] =
            tmpl_RationalNumber_Add(first->coeffs[n], second->coeffs[n]);
    ...
    if (tmpl_RationalNumber_Is_Zero(sum->coeffs[sum->degree]))
        tmpl_PolynomialQ_Shrink(sum);
