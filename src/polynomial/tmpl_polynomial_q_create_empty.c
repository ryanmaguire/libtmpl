 ...
 ******************************************************************************
 *                       tmpl_polynomial_q_create_empty                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for creating a polynomial in Q[x] with all pointers set to NULL  *
 *      and all variables set to their zero values.                           *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_PolynomialQ_Create_Empty                                         *
 *  Purpose:                                                                  *
 *      Creates a pointer to a polynomial in Q[x] with coeffs set to NULL,    *
...
tmpl_PolynomialQ *tmpl_PolynomialQ_Create_Empty(void)
{
...
/*  End of tmpl_PolynomialQ_Create_Empty.                                     */
