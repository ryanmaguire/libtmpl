 ...
 ******************************************************************************
 *                       tmpl_create_empty_polynomial_q                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Code for creating a polynomial in Q[x] with it's coeffs pointer set   *
...
tmpl_PolynomialQ *tmpl_Create_Empty_PolynomialQ(void)
{
...
/*  End of tmpl_Create_Empty_PolynomialQ.                                     */
