 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      See include/math/tmpl_positive_difference_double.h for details. This  *
 *      function computes max(x-y, 0). Equivalent to the C99 fdim function.   *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       June 12, 2023                                                 *
 ******************************************************************************/
...
/*  Implemented in include/math/tmpl_positive_difference_double.h.            */
#include "../../include/inline/math/tmpl_positive_difference_double.h"
