...
tmpl_Double_SinCos_Reduction_Very_Large(double x, double *a, double *aa)
{
    ...
    const double t576 = 2.473304014731045340605025210196E173; /* 2^576 */
    const double tm600 = 2.409919865102884117740750034713E-181; /* 2^-600 */
    const double tm24 = 5.9604644775390625E-08; /* 2^-24 */
    const double big = 6.755399441055744E15; /* 1.5 * 2^52 */
    const double big1 = 2.7021597764222976E16; /* 1.5 * 2^54 */
    const double hp0 = 1.570796326794896557998981734272E00;  /* pi / 2 hi */
    const double hp1 = 6.123233995736766035868820147292E-17; /* pi / 2 lo */
    const double mp1 = 1.5707963407039642333984375E00;        /* pi / 2 hi */
    const double mp2 = -1.390906767539945576572790741920E-08; /* pi / 2 lo */
    unsigned int k;
