 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the rational minimax approximation for asin(x) centered      *
 ...
 *  Purpose:                                                                  *
 *      Computes the rational minimax approximation for arcsin.               *
 *  Arguments:                                                                *
 *      x (long double):                                                      *
 *          A real number.                                                    *
 *  Output:                                                                   *
 ...
 *      Remez exchange algorithm. The order of the approximation depends on   *
 *      how long double is implemented.                                       *
 *                                                                            *
 *      64-bit double:                                                        *
