...
#ifndef TMPL_SINH_MACLAURIN_FLOAT_H
#define TMPL_SINH_MACLAURIN_FLOAT_H
...
#define A02 (+8.3333333333333333333333333333333333333333333333333E-03F)

/*  Maclaurin series of hyperbolic cosine to 3 terms.                         */
TMPL_STATIC_INLINE
float tmpl_Float_Sinh_Maclaurin(float x)
{
    /*  The function is odd and the series is in terms of x^{2n+1}.           */
    const float x2 = x*x;

    /*  Compute the polynomial via Horner's method and return.                */
    return x*(A00 + x2*(A01 + x2*A02));
}
/*  End of tmpl_Float_Sinh_Maclaurin.                                         */
