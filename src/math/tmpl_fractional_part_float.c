...
/*  Function for computing the fractional part of a float.                    */
float tmpl_Float_Fractional_Part(float x)
{
...
/*  End of tmpl_Float_Fractional_Part.                                        */
...
float tmpl_Float_Fractional_Part(float x)
{
    ...
    /*  w is now correctly set to the truncation of the input. The            *
     *  fractional part is x - trunc(x). Return this.                         */
    return x - w.r;
}
/*  End of tmpl_Float_Fractional_Part.                                        */
