 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the fractional part of a double.                             *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
...
double tmpl_Double_Fractional_Part(double x)
{
     ...
     *  the input is already an integer. Return 0.                            */
    ...
    /*  word64 now has the truncation of the input. Return x - trunc(x).      */
    return x - word64.f;
}
/*  End of tmpl_Double_Fractional_Part.                                       */
...
double tmpl_Double_Fractional_Part(double x)
{
    ...
    /*  For very large arguments, |x| >= 2^52, x is an integer. Return 0.     */
    ...
    else
    {
        ...
        goto TMPL_DOUBLE_FRACTIONAL_PART_FINISH;
    }
...
TMPL_DOUBLE_FRACTIONAL_PART_FINISH:
 ...
 *                                                                            *
 *      On x86_64 machines, the assembly code and both versions of the        *
...
double tmpl_Double_Fractional_Part(double x)
{
    ...
    /*  If expo < 0 we have |x| < 1. x mod 1 = x.                             */
    if (expo < 0)
        return x;
    ...
    /*  For positive values, we are done with the computation of trunc(x).    *
