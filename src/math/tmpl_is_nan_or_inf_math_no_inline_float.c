 ...
 ******************************************************************************
 *                          tmpl_is_nan_or_inf_float                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      See include/math/tmpl_is_nan_or_inf_float.h for details.              *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
/*  Implemented in include/math/tmpl_is_nan_or_inf_float.h.                   */
#include "../../include/inline/math/tmpl_is_nan_or_inf_float.h"
