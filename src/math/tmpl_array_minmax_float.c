 ...
 ******************************************************************************
 *                          tmpl_array_minmax_float                           *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the min and max of a float array.                            *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Float_Array_MinMax                                               *
 *  Purpose:                                                                  *
 ...
 *  Output:                                                                   *
 *      min (float *):                                                        *
 *          A pointer to a float. The min of the array will be stored here.   *
 *      max (float *):                                                        *
 *          A pointer to a float. The max of the array will be stored here.   *
 *  Called Functions:                                                         *
...
#ifndef TMPL_FLOAT_ARRAY_MINMAX_METHOD
#define TMPL_FLOAT_ARRAY_MINMAX_METHOD 1
#endif
...
/*  End of tmpl_Float_Array_MinMax.                                           */
...
#endif
/*  End of #if TMPL_FLOAT_ARRAY_MINMAX_METHOD == 1.                           */

/*  The rest of libtmpl does not need this, so undef it.                      */
#undef TMPL_FLOAT_ARRAY_MINMAX_METHOD
