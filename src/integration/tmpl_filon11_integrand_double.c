 ...
 ******************************************************************************
 *                       tmpl_filon11_integrand_double                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the integral of f(t) exp(i g(t)) assuming affine f and g,    *
 *      f(t) = a t + b (a and b are real), g(t) = c t + d (c and d are real). *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *      (a and b are real), and g(t) = c t + d (c and d are real).            *
 *  Arguments:                                                                *
 *      left (const double):                                                  *
                              ...
                              const double width)
{
    ...
    tmpl_ComplexDouble z_left, z_right;
    ...
    if (tmpl_Double_Abs(g_diff) < threshold)
    {
        ...
        z_left = tmpl_CDouble_Multiply_Real(left, exp_left);
        z_right = tmpl_CDouble_Multiply_Real(right, exp_right);
    ...
    else
    {
        ...
        const double factor = (right - left) / g_diff;

        /*  Next, compute exp(i g(L)) (i f(L) - a / c).                       */
        z_left = tmpl_CDouble_Rect(-factor, left);
        tmpl_CDouble_MultiplyBy(&z_left, &exp_left);

        /*  Now compute exp(i g(R)) (i f(R) - a / c).                         */
        z_right = tmpl_CDouble_Rect(-factor, right);
...
/*  End of tmpl_Double_Filon11_Integrand.                                     */
