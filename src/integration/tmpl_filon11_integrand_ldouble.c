 ...
 ******************************************************************************
 *                       tmpl_filon11_integrand_ldouble                       *
 ******************************************************************************
 *  Purpose:                                                                  *
                               ...
                               const long double width)
{
    ...
    tmpl_ComplexLongDouble z_left, z_right;
    ...
    if (tmpl_LDouble_Abs(g_diff) < threshold)
    {
        ...
        z_left = tmpl_CLDouble_Multiply_Real(left, exp_left);
        z_right = tmpl_CLDouble_Multiply_Real(right, exp_right);
    ...
    else
    {
        ...
        const long double factor = (right - left) / g_diff;

        /*  Next, compute exp(i g(L)) (i f(L) - a / c).                       */
        z_left = tmpl_CLDouble_Rect(-factor, left);
        tmpl_CLDouble_MultiplyBy(&z_left, &exp_left);

        /*  Now compute exp(i g(R)) (i f(R) - a / c).                         */
        z_right = tmpl_CLDouble_Rect(-factor, right);
...
/*  End of tmpl_LDouble_Filon11_Integrand.                                    */
