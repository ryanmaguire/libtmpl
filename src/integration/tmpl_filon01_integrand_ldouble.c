 ...
 ******************************************************************************
 *                       tmpl_filon01_integrand_ldouble                       *
 ******************************************************************************
 *  Purpose:                                                                  *
                               ...
                               const long double width)
{
    ...
    tmpl_CLDouble_MultiplyBy_Real(&integrand, value);
    return integrand;
}
/*  End of tmpl_LDouble_Filon01_Integrand.                                    */
