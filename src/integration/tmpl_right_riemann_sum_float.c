...
float tmpl_Float_Right_Riemann_Sum(const float *arr, float dx, size_t len)
{
...
/*  End of tmpl_Float_Right_Riemann_Sum.                                      */
