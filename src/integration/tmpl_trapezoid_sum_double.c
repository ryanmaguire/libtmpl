...
double tmpl_Double_Trapezoid_Sum(const double *arr, double dx, size_t len)
{
    ...
    return (sum + (arr[zero] + arr[sum_len]) * 0.5) * dx;
}
/*  End of tmpl_Double_Trapezoid_Sum.                                         */
