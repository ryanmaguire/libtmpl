...
/*  Standard Fast2Diff algorithm at long double precision.                    */
TMPL_ALWAYS_INLINE
void
...
/*  End of tmpl_LDouble_Fast_Two_Diff.                                        */
