 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Two_Diff                                                 *
 *  Purpose:                                                                  *
 *      Evaluates the difference of two long doubles with compensation error. *
 *  Arguments:                                                                *
 *      x (const long double):                                                *
 *          A real number.                                                    *
 *      y (const long double):                                                *
 ...
 *      beneficial to use the Fast2Diff algorithm, tmpl_LDouble_Fast_Two_Diff,*
...
/*  Standard 2Diff algorithm at long double precision.                        */
TMPL_ALWAYS_INLINE
void
                      ...
                      long double * TMPL_RESTRICT const err)
{
    ...
    long double diff, err_sum, xc, yc, xerr, yerr;
