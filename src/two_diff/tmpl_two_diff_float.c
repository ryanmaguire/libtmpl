 ...
 *      tmpl_Float_Two_Diff                                                   *
 *  Purpose:                                                                  *
 *      Evaluates the difference of two floats with compensation error.       *
 *  Arguments:                                                                *
 *      x (const float):                                                      *
 *          A real number.                                                    *
 *      y (const float):                                                      *
 ...
 *      beneficial to use the Fast2Diff algorithm, tmpl_Float_Fast_Two_Diff,  *
...
/*  Standard 2Diff algorithm at single precision.                             */
TMPL_ALWAYS_INLINE
void
                    ...
                    float * TMPL_RESTRICT const err)
{
    ...
    float diff, err_sum, xc, yc, xerr, yerr;
