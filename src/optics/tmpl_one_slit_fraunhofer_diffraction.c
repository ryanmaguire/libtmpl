...
float tmpl_Float_One_Slit_Fraunhofer_Diffraction(float x, float z, float a)
{
...
double tmpl_Double_One_Slit_Fraunhofer_Diffraction(double x, double z, double a)
{
    /*  Declare necessary variables.                                          */
    double result;
                                             ...
                                             long double a)
{
    ...
    {
        /*  Single slit is computed in terms of the sinc function.            */
        result  = tmpl_LDouble_Sinc(a*x/z);
        result *= result;
    }
