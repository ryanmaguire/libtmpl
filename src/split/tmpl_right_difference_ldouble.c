                              ...
                              const long double c)
{
    ...
    long double b_val, b_minus_c, result;
    ...
    b_minus_c = b_val - c;
    TMPL_LDOUBLE_BARRIER(b_minus_c);
...
/*  End of tmpl_LDouble_Right_Difference.                                     */
