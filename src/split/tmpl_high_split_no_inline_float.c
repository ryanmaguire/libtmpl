 ...
 *      include/split/tmpl_high_split_double.h. for details.                  *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       August 28, 2024                                               *
 ******************************************************************************/
...
/*  Implemented in include/split/tmpl_high_split_float.h.                     */
#include "../../include/inline/split/tmpl_high_split_float.h"
