...
/*  Function for adding two floats with compiler barriers.                    */
TMPL_ALWAYS_INLINE
float tmpl_Float_Guarded_Add(const float a, const float b)
{
    /*  Declare variables for the intermediate steps.                         */
    float a_val, b_val, sum;
