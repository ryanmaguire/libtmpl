 ...
 ******************************************************************************
 *                           tmpl_guarded_add_double                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Performs floating-point addition with a guard against optimizations.  *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *      -ffast-math and then perform the sum.                                 *
 *  Notes:                                                                    *
...
/*  Function for adding two doubles with compiler barriers.                   */
TMPL_ALWAYS_INLINE
double tmpl_Double_Guarded_Add(const double a, const double b)
{
    /*  Declare variables for the intermediate steps.                         */
    double a_val, b_val, sum;
     ...
     *  the sum performed in this function. Make a copy and create a barrier. */
    a_val = a;
    TMPL_DOUBLE_BARRIER(a_val);

    /*  Provide the same protection for b.                                    */
    b_val = b;
    TMPL_DOUBLE_BARRIER(b_val);

    /*  a and b are now guarded against aggressive optimizations, add them.   */
    sum = a_val + b_val;
...
/*  End of tmpl_Double_Guarded_Add.                                           */
