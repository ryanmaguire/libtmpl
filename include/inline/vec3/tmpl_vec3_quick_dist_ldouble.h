 ...
 *          tmpl_3DLDouble_Dist instead. That function safely handles         *
 *          overflow and underflow, but it is slower.                         *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_config.h:                                                        *
...
#ifndef TMPL_VEC3_QUICK_DIST_LDOUBLE_H
#define TMPL_VEC3_QUICK_DIST_LDOUBLE_H
                          ...
                          const tmpl_ThreeVectorLongDouble * const Q)
{
    ...
    return tmpl_LDouble_Quick_Hypot3(dx, dy, dz);
}
/*  End of tmpl_3DLDouble_Quick_Dist.                                         */
