 ...
 *          tmpl_3DDouble_Dist instead. That function safely handles overflow *
...
#ifndef TMPL_VEC3_QUICK_DIST_DOUBLE_H
#define TMPL_VEC3_QUICK_DIST_DOUBLE_H
                         ...
                         const tmpl_ThreeVectorDouble * const Q)
{
    ...
    return tmpl_Double_Quick_Hypot3(dx, dy, dz);
}
/*  End of tmpl_3DDouble_Quick_Dist.                                          */
