 ...
 *      3.) Unlike tmpl_3DFloat_L2_Norm, this function does not prevent       *
...
#ifndef TMPL_VEC3_QUICK_L2_NORM_FLOAT_H
#define TMPL_VEC3_QUICK_L2_NORM_FLOAT_H
...
TMPL_INLINE_DECL
float tmpl_3DFloat_Quick_L2_Norm(const tmpl_ThreeVectorFloat * const P)
{
    /*  The hypot3 function computes using the Pythagoras formula. Use this.  */
    return tmpl_Float_Quick_Hypot3(P->dat[0], P->dat[1], P->dat[2]);
}
/*  End of tmpl_3DFloat_Quick_L2_Norm.                                        */
