 ...
 ******************************************************************************
 *                     tmpl_vec3_quick_component_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *  Output:                                                                   *
 *      comp_QP (tmpl_ThreeVectorLongDouble):                                 *
 ...
 *          tmpl_3DLDouble_Component. That function safely handles overflow,  *
 *          but is much slower.                                               *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
...
#ifndef TMPL_VEC3_QUICK_COMPONENT_LDOUBLE_H
#define TMPL_VEC3_QUICK_COMPONENT_LDOUBLE_H
                               ...
                               const tmpl_ThreeVectorLongDouble * const Q)
{
    ...
    tmpl_ThreeVectorLongDouble component;

    /*  The scale factor is (P . Q) / ||Q||^2.                                */
    const long double factor = tmpl_3DLDouble_Dot_Product(P, Q) /
                               tmpl_3DLDouble_L2_Norm_Squared(Q);
...
/*  End of tmpl_3DLDouble_Quick_Component.                                    */
