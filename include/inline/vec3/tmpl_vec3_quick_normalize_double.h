 ...
 ******************************************************************************
 *                      tmpl_vec3_quick_normalize_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *          tmpl_3DDouble_Normalize if you are working with vectors that      *
...
#ifndef TMPL_VEC3_QUICK_NORMALIZE_DOUBLE_H
#define TMPL_VEC3_QUICK_NORMALIZE_DOUBLE_H
...
tmpl_3DDouble_Quick_Normalize(const tmpl_ThreeVectorDouble * const P)
{
    ...
    const double rcpr_norm =
        1.0 / tmpl_Double_Quick_Hypot3(P->dat[0], P->dat[1], P->dat[2]);
...
/*  End of tmpl_3DDouble_Quick_Normalize.                                     */
