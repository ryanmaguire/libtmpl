 ...
 ******************************************************************************
 *                      tmpl_vec3_orthogonal_part_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC3_ORTHOGONAL_PART_DOUBLE_H
#define TMPL_VEC3_ORTHOGONAL_PART_DOUBLE_H
                              ...
                              const tmpl_ThreeVectorDouble * const Q)
{
    ...
    const tmpl_ThreeVectorDouble component = tmpl_3DDouble_Component(P, Q);
    return tmpl_3DDouble_Subtract(P, &component);
}
/*  End of tmpl_3DDouble_Orthogonal_Part.                                     */
