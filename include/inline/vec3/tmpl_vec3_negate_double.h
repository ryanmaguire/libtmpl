 ...
 *  Output:                                                                   *
 *      minus_P (tmpl_ThreeVectorDouble):                                     *
...
#ifndef TMPL_VEC3_NEGATE_DOUBLE_H
#define TMPL_VEC3_NEGATE_DOUBLE_H
...
tmpl_3DDouble_Negate(const tmpl_ThreeVectorDouble * const P)
{
    ...
    tmpl_ThreeVectorDouble minus_P;
