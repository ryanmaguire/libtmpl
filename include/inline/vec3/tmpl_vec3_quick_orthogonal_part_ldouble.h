 ...
 ******************************************************************************
 *                   tmpl_vec3_quick_orthogonal_part_float                    *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *      4.) This function does not carefully handle overflow or underflow.    *
 *          If you are working with vectors that have very large magnitudes,  *
 *          use tmpl_3DLDouble_Orthogonal_Part. That function safely handles  *
 *          overflow and underflow, but is slower.                            *
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) tmpl_config.h:                                                        *
...
#ifndef TMPL_VEC3_QUICK_ORTHOGONAL_PART_LDOUBLE_H
#define TMPL_VEC3_QUICK_ORTHOGONAL_PART_LDOUBLE_H
...
tmpl_3DLDouble_Quick_Orthogonal_Part(const tmpl_ThreeVectorLongDouble * const P,
                                     const tmpl_ThreeVectorLongDouble * const Q)
{
    /*  Variable for the output.                                              */
    const tmpl_ThreeVectorLongDouble component
        = tmpl_3DLDouble_Quick_Component(P, Q);
    return tmpl_3DLDouble_Subtract(P, &component);
}
/*  End of tmpl_3DLDouble_Quick_Orthogonal_Part.                              */
