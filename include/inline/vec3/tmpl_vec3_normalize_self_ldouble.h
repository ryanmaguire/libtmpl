...
#ifndef TMPL_VEC3_NORMALIZE_SELF_LDOUBLE_H
#define TMPL_VEC3_NORMALIZE_SELF_LDOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_3DLDouble_NormalizeSelf(tmpl_ThreeVectorLongDouble * const P)
{
