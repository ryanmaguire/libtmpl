 ...
 ******************************************************************************
 *                       tmpl_vec3_normalize_self_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Contains code for normalizing a vector at double precision.           *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_3DDouble_NormalizeSelf                                           *
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC3_NORMALIZE_SELF_DOUBLE_H
#define TMPL_VEC3_NORMALIZE_SELF_DOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_3DDouble_NormalizeSelf(tmpl_ThreeVectorDouble * const P)
{
    /*  The negative of a vector negates all of the components.               */
    const double rcpr_norm = 1.0 / tmpl_3DDouble_L2_Norm(P);
    P->dat[0] *= rcpr_norm;
    P->dat[1] *= rcpr_norm;
    P->dat[2] *= rcpr_norm;
}
/*  End of tmpl_3DDouble_NormalizeSelf.                                       */
