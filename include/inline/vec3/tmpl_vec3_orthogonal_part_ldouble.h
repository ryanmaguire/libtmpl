 ...
 ******************************************************************************
 *                     tmpl_vec3_orthogonal_part_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_3DLDouble_Orthogonal_Part                                        *
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC3_ORTHOGONAL_PART_LDOUBLE_H
#define TMPL_VEC3_ORTHOGONAL_PART_LDOUBLE_H
                               ...
                               const tmpl_ThreeVectorLongDouble * const Q)
{
    ...
    const tmpl_ThreeVectorLongDouble component = tmpl_3DLDouble_Component(P, Q);
    return tmpl_3DLDouble_Subtract(P, &component);
}
/*  End of tmpl_3DLDouble_Orthogonal_Part.                                    */
