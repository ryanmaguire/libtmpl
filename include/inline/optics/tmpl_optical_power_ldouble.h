...
#ifndef TMPL_OPTICAL_POWER_LDOUBLE_H
#define TMPL_OPTICAL_POWER_LDOUBLE_H
...
TMPL_INLINE_DECL
long double tmpl_CLDouble_Optical_Power(tmpl_ComplexLongDouble transmittance)
{
    /*  Transmittance is sqrt(power) * exp(i phase). Power can be computed    *
     *  from the square of the absolute value of the transmittance.           */
    return tmpl_CLDouble_Abs_Squared(transmittance);
}
/*  End of tmpl_CLDouble_Optical_Power.                                       */
