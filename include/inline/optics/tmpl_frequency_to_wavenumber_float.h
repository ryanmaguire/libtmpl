 ...
 ******************************************************************************
 *                     tmpl_frequency_to_wavenumber_float                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_Float_Frequency_To_Wavenumber                                    *
 *  Purpose:                                                                  *
...
#ifndef TMPL_FREQUENCY_TO_WAVENUMBER_FLOAT_H
#define TMPL_FREQUENCY_TO_WAVENUMBER_FLOAT_H
...
TMPL_INLINE_DECL
float tmpl_Float_Frequency_To_Wavenumber(float frequency)
{
    /*  The conversion factor is 2 pi over the speed of light.                */
    return 2.095845021951681812130606289821675823611E-05F * frequency;
}
/*  End of tmpl_Float_Frequency_To_Wavenumber.                                */
