 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_LDouble_Wavelength_To_Wavenumber                                 *
 *  Purpose:                                                                  *
...
#ifndef TMPL_WAVELENGTH_TO_WAVENUMBER_LDOUBLE_H
#define TMPL_WAVELENGTH_TO_WAVENUMBER_LDOUBLE_H
...
long double tmpl_LDouble_Wavelength_To_Wavenumber(long double lambda)
{
    ...
    return 6.283185307179586476925286766559005768394L / lambda;
}
/*  End of tmpl_LDouble_Wavelength_To_Wavenumber.                             */
