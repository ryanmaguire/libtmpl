 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_CLDouble_Optical_Phase                                           *
 *  Purpose:                                                                  *
 *      Computes phase from (complex) optical transmittance.                  *
 *  Arguments:                                                                *
 *      transmittance (tmpl_ComplexLongDouble):                               *
...
#ifndef TMPL_OPTICAL_PHASE_LDOUBLE_H
#define TMPL_OPTICAL_PHASE_LDOUBLE_H
...
TMPL_INLINE_DECL
long double tmpl_CLDouble_Optical_Phase(tmpl_ComplexLongDouble transmittance)
{
    ...
    return tmpl_LDouble_Arctan2(transmittance.dat[1], transmittance.dat[0]);
}
/*  End of tmpl_CLDouble_Optical_Phase.                                       */
