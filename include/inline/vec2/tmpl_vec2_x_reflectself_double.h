 ...
 ******************************************************************************
 *                       tmpl_vec2_x_reflectself_double                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC2_X_REFLECTSELF_DOUBLE_H
#define TMPL_VEC2_X_REFLECTSELF_DOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DDouble_X_ReflectSelf(tmpl_TwoVectorDouble * const P)
{
    /*  The reflection simply negates the y coordinate of P.                  */
    P->dat[1] = -P->dat[1];
}
/*  End of tmpl_2DDouble_X_ReflectSelf.                                       */
