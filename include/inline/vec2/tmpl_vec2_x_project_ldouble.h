 ...
 *  Output:                                                                   *
 *      x_projection (tmpl_TwoVectorLongDouble):                              *
...
#ifndef TMPL_VEC2_X_PROJECT_LDOUBLE_H
#define TMPL_VEC2_X_PROJECT_LDOUBLE_H
...
tmpl_2DLDouble_X_Project(const tmpl_TwoVectorLongDouble * const P)
{
    ...
    tmpl_TwoVectorLongDouble x_projection;

    /*  The projection copies the x component and zeroes out the y value.     */
    x_projection.dat[0] = P->dat[0];
    x_projection.dat[1] = 0.0L;
    return x_projection;
}
/*  End of tmpl_2DLDouble_X_Project.                                          */
