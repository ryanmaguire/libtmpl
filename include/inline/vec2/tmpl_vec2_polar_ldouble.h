...
#ifndef TMPL_VEC2_POLAR_LDOUBLE_H
#define TMPL_VEC2_POLAR_LDOUBLE_H
...
TMPL_INLINE_DECL
tmpl_TwoVectorLongDouble tmpl_2DLDouble_Polar(long double r, long double theta)
{
    /*  Declare necessary variables. C89 requires declarations at the top.    */
    tmpl_TwoVectorLongDouble P;

    /*  Compute sin(theta) and cos(theta) simultaneously.                     */
    tmpl_LDouble_SinCos(theta, &P.dat[1], &P.dat[0]);
