 ...
 ******************************************************************************
 *                      tmpl_vec2_x_projectself_ldouble                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC2_X_PROJECTSELF_LDOUBLE_H
#define TMPL_VEC2_X_PROJECTSELF_LDOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DLDouble_X_ProjectSelf(tmpl_TwoVectorLongDouble * const P)
{
    /*  The projection simply zeros out the y coordinate of P.                */
    P->dat[1] = 0.0L;
}
/*  End of tmpl_2DLDouble_X_ProjectSelf.                                      */
