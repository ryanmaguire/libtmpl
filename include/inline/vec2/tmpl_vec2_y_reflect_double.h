...
#ifndef TMPL_VEC2_Y_REFLECT_DOUBLE_H
#define TMPL_VEC2_Y_REFLECT_DOUBLE_H
...
tmpl_2DDouble_Y_Reflect(const tmpl_TwoVectorDouble * const P)
{
    ...
    tmpl_TwoVectorDouble y_reflection;
...
/*  End of tmpl_2DDouble_Y_Reflect.                                           */
