 ...
 ******************************************************************************
 *                       tmpl_vec2_y_reflectself_double                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC2_Y_REFLECTSELF_DOUBLE_H
#define TMPL_VEC2_Y_REFLECTSELF_DOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DDouble_Y_ReflectSelf(tmpl_TwoVectorDouble * const P)
{
    /*  The reflection simply negates the x coordinate of P.                  */
    P->dat[0] = -P->dat[0];
}
/*  End of tmpl_2DDouble_Y_ReflectSelf.                                       */
