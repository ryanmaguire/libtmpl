 ...
 *  Output:                                                                   *
 *      y_projection (tmpl_TwoVectorFloat):                                   *
...
#ifndef TMPL_VEC2_Y_PROJECT_FLOAT_H
#define TMPL_VEC2_Y_PROJECT_FLOAT_H
...
tmpl_2DFloat_Y_Project(const tmpl_TwoVectorFloat * const P)
{
    ...
    tmpl_TwoVectorFloat y_projection;
