 ...
 ******************************************************************************
 *                      tmpl_vec2_hadamard_divide_float                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides Hadamard division for single precision 2D vectors.           *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_2DFloat_Hadamard_Divide                                          *
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC2_HADAMARD_DIVIDE_FLOAT_H
#define TMPL_VEC2_HADAMARD_DIVIDE_FLOAT_H
...
/*  End of tmpl_2DFloat_Hadamard_Divide.                                      */
