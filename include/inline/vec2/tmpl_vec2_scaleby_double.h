 ...
 ******************************************************************************
 *                          tmpl_vec2_scaleby_double                          *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      In-place scalar multiplication for double precision 2D vectors.       *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *      2.) This function acts as the "*=" operator for tmpl_TwoVectorDouble. *
...
#ifndef TMPL_VEC2_SCALEBY_DOUBLE_H
#define TMPL_VEC2_SCALEBY_DOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DDouble_ScaleBy(tmpl_TwoVectorDouble * const P, double r)
{
    /*  The scalar product of r and P scales the components.                  */
    P->dat[0] *= r;
    P->dat[1] *= r;
}
/*  End of tmpl_2DDouble_ScaleBy.                                             */
