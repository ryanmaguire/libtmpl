 ...
 *  Output:                                                                   *
 *      x_reflection (tmpl_TwoVectorFloat):                                   *
...
#ifndef TMPL_VEC2_X_REFLECT_FLOAT_H
#define TMPL_VEC2_X_REFLECT_FLOAT_H
...
tmpl_2DFloat_X_Reflect(const tmpl_TwoVectorFloat * const P)
{
    ...
    tmpl_TwoVectorFloat x_reflection;
