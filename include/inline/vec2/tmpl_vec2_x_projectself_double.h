 ...
 ******************************************************************************
 *                       tmpl_vec2_x_projectself_double                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC2_X_PROJECTSELF_DOUBLE_H
#define TMPL_VEC2_X_PROJECTSELF_DOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DDouble_X_ProjectSelf(tmpl_TwoVectorDouble * const P)
{
    /*  The projection simply zeros out the y coordinate of P.                */
    P->dat[1] = 0.0;
}
/*  End of tmpl_2DDouble_X_ProjectSelf.                                       */
