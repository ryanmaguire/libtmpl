 ...
 *                  = sqrt(a^2 + b^2)                                         *
 *                                                                            *
 *      This is computed using the tmpl_Float_Hypot function.                 *
 *  Notes:                                                                    *
...
#ifndef TMPL_VEC2_L2_NORM_FLOAT_H
#define TMPL_VEC2_L2_NORM_FLOAT_H
...
TMPL_INLINE_DECL
float tmpl_2DFloat_L2_Norm(const tmpl_TwoVectorFloat * const P)
{
