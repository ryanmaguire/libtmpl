 ...
 *  Output:                                                                   *
 *      y_reflection (tmpl_TwoVectorLongDouble):                              *
...
#ifndef TMPL_VEC2_Y_REFLECT_LDOUBLE_H
#define TMPL_VEC2_Y_REFLECT_LDOUBLE_H
...
tmpl_2DLDouble_Y_Reflect(const tmpl_TwoVectorLongDouble * const P)
{
    ...
    tmpl_TwoVectorLongDouble y_reflection;
...
/*  End of tmpl_2DLDouble_Y_Reflect.                                          */
