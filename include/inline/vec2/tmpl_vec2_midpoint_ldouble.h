 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_2DLDouble_Midpoint                                               *
 *  Purpose:                                                                  *
 *      Computes the midpoint of two long double precision 2D vectors.        *
 *  Arguments:                                                                *
...
#ifndef TMPL_VEC2_MIDPOINT_LDOUBLE_H
#define TMPL_VEC2_MIDPOINT_LDOUBLE_H
