 ...
 ******************************************************************************
 *                      tmpl_vec2_y_reflectself_ldouble                       *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_VEC2_Y_REFLECTSELF_LDOUBLE_H
#define TMPL_VEC2_Y_REFLECTSELF_LDOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DLDouble_Y_ReflectSelf(tmpl_TwoVectorLongDouble * const P)
{
    /*  The reflection simply negates the x coordinate of P.                  */
    P->dat[0] = -P->dat[0];
}
/*  End of tmpl_2DLDouble_Y_ReflectSelf.                                      */
