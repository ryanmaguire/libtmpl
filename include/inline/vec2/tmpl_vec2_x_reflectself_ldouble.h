 ...
 ******************************************************************************
 *                      tmpl_vec2_x_reflectself_ldouble                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *          y = -b                                                            *
 *                                                                            *
 *      We negate the y coordinate of P and return.                           *
 *  Notes:                                                                    *
...
#ifndef TMPL_VEC2_X_REFLECTSELF_LDOUBLE_H
#define TMPL_VEC2_X_REFLECTSELF_LDOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DLDouble_X_ReflectSelf(tmpl_TwoVectorLongDouble * const P)
{
    /*  The reflection simply negates the y coordinate of P.                  */
    P->dat[1] = -P->dat[1];
}
/*  End of tmpl_2DLDouble_X_ReflectSelf.                                      */
