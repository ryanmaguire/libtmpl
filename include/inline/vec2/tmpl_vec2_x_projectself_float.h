...
#ifndef TMPL_VEC2_X_PROJECTSELF_FLOAT_H
#define TMPL_VEC2_X_PROJECTSELF_FLOAT_H
...
TMPL_INLINE_DECL
void tmpl_2DFloat_X_ProjectSelf(tmpl_TwoVectorFloat * const P)
{
    /*  The projection simply zeros out the y coordinate of P.                */
    P->dat[1] = 0.0F;
}
/*  End of tmpl_2DFloat_X_ProjectSelf.                                        */
