 ...
 ******************************************************************************
 *                       tmpl_vec2_polar_angle_ldouble                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes the angle a vector makes with the positive x axis.           *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_2DLDouble_Polar_Angle                                            *
 *  Purpose:                                                                  *
 ...
 *  Output:                                                                   *
 *      angle (long double):                                                  *
 *          The angle, in radians, the point P makes with the x axis.         *
 *  Called Functions:                                                         *
 *      src/math/                                                             *
 ...
 *      2.) The returned angle is in radians and lies between -pi and pi.     *
...
#ifndef TMPL_VEC2_POLAR_ANGLE_LDOUBLE_H
#define TMPL_VEC2_POLAR_ANGLE_LDOUBLE_H
...
/*  Function for computing the angle a vector makes with the positive x axis. */
TMPL_INLINE_DECL
long double tmpl_2DLDouble_Polar_Angle(const tmpl_TwoVectorLongDouble * const P)
{
    return tmpl_LDouble_Arctan2(P->dat[1], P->dat[0]);
}
/*  End of tmpl_2DLDouble_Polar_Angle.                                        */
