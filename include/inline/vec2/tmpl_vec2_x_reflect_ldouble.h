 ...
 *  Output:                                                                   *
 *      x_reflection (tmpl_TwoVectorLongDouble):                              *
...
#ifndef TMPL_VEC2_X_REFLECT_LDOUBLE_H
#define TMPL_VEC2_X_REFLECT_LDOUBLE_H
...
tmpl_2DLDouble_X_Reflect(const tmpl_TwoVectorLongDouble * const P)
{
    ...
    tmpl_TwoVectorLongDouble x_reflection;
...
/*  End of tmpl_2DLDouble_X_Reflect.                                          */
