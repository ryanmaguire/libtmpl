...
#ifndef TMPL_VEC2_POLAR_ANGLE_DOUBLE_H
#define TMPL_VEC2_POLAR_ANGLE_DOUBLE_H
...
TMPL_INLINE_DECL
double tmpl_2DDouble_Polar_Angle(const tmpl_TwoVectorDouble * const P)
{
    return tmpl_Double_Arctan2(P->dat[1], P->dat[0]);
}
/*  End of tmpl_2DDouble_Polar_Angle.                                         */
