...
#ifndef TMPL_VEC2_POLAR_ANGLE_FLOAT_H
#define TMPL_VEC2_POLAR_ANGLE_FLOAT_H
...
TMPL_INLINE_DECL
float tmpl_2DFloat_Polar_Angle(const tmpl_TwoVectorFloat * const P)
{
    return tmpl_Float_Arctan2(P->dat[1], P->dat[0]);
}
/*  End of tmpl_2DFloat_Polar_Angle.                                          */
