...
#ifndef TMPL_VEC2_Y_PROJECTSELF_FLOAT_H
#define TMPL_VEC2_Y_PROJECTSELF_FLOAT_H
...
TMPL_INLINE_DECL
void tmpl_2DFloat_Y_ProjectSelf(tmpl_TwoVectorFloat * const P)
{
    /*  The projection simply zeros out the x coordinate of P.                */
    P->dat[0] = 0.0F;
}
/*  End of tmpl_2DFloat_Y_ProjectSelf.                                        */
