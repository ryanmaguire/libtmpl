 ...
 ******************************************************************************
 *                    tmpl_vec2_hadamard_divideby_ldouble                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides in-place Hadamard division for 2D vectors.                   *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_2DLDouble_Hadamard_DivideBy                                      *
 *  Purpose:                                                                  *
 *      Divides two points in the plane component-wise in-place.              *
 *  Arguments:                                                                *
 *      P (tmpl_TwoVectorLongDouble * const):                                 *
 *          A pointer to a point in the Euclidean plane. The quotient is      *
 *          stored here.                                                      *
 ...
 *      3.) This function is the "/=" operator for tmpl_TwoVectorLongDouble.  *
...
#ifndef TMPL_VEC2_HADAMARD_DIVIDEBY_LDOUBLE_H
#define TMPL_VEC2_HADAMARD_DIVIDEBY_LDOUBLE_H
...
/*  Function for dividing 2 two-dimensional vectors in-place.                 */
TMPL_INLINE_DECL
void
...
/*  End of tmpl_2DLDouble_Hadamard_DivideBy.                                  */
