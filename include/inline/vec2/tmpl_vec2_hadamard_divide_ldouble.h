 ...
 ******************************************************************************
 *                     tmpl_vec2_hadamard_divide_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides Hadamard division for long double precision 2D vectors.      *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_2DLDouble_Hadamard_Divide                                        *
 *  Purpose:                                                                  *
...
#define TMPL_VEC2_HADAMARD_DIVIDE_LDOUBLE_H
#ifndef TMPL_VEC2_HADAMARD_DIVIDE_LDOUBLE_H
...
/*  End of tmpl_2DLDouble_Hadamard_Divide.                                    */
