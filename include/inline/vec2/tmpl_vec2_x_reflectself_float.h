...
#ifndef TMPL_VEC2_X_REFLECTSELF_FLOAT_H
#define TMPL_VEC2_X_REFLECTSELF_FLOAT_H
...
TMPL_INLINE_DECL
void tmpl_2DFloat_X_ReflectSelf(tmpl_TwoVectorFloat * const P)
{
    /*  The reflection simply negates the y coordinate of P.                  */
    P->dat[1] = -P->dat[1];
}
/*  End of tmpl_2DFloat_X_ReflectSelf.                                        */
