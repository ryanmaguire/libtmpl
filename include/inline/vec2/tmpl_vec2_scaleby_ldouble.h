...
#ifndef TMPL_VEC2_SCALEBY_LDOUBLE_H
#define TMPL_VEC2_SCALEBY_LDOUBLE_H
...
TMPL_INLINE_DECL
void tmpl_2DLDouble_ScaleBy(tmpl_TwoVectorLongDouble * const P, long double r)
{
    /*  The scalar product of r and P scales the components.                  */
    P->dat[0] *= r;
    P->dat[1] *= r;
}
/*  End of tmpl_2DLDouble_ScaleBy.                                            */
