...
#define TMPL_VEC2_Y_LDOUBLE_H
#ifndef TMPL_VEC2_Y_LDOUBLE_H
...
TMPL_INLINE_DECL
long double tmpl_2DLDouble_Y(const tmpl_TwoVectorLongDouble * const P)
{
     ...
     *  elements. The y coordinate is the first element. Return this.         */
    return P->dat[1];
}
/*  End of tmpl_2DLDouble_Y.                                                  */
