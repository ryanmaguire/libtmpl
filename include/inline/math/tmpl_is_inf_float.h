 ...
 *      Added inline support. Changed src/math/tmpl_is_inf_float.c to         *
 *      include this file.                                                    *
 ******************************************************************************/

/*  Include guard to prevent including this file twice.                       */
#ifndef TMPL_IS_INF_FLOAT_H
#define TMPL_IS_INF_FLOAT_H
...
/*  Function for testing if a float is +/- infinity (isinff equivalent).      */
TMPL_INLINE_DECL
