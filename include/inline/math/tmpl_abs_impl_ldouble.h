 ...
 *      use fabsl from math.h if TMPL_USE_MATH_ALGORITHMS is not 1.           *
...
#ifndef TMPL_INLINE_MATH_ABS_IMPL_LDOUBLE_H
#define TMPL_INLINE_MATH_ABS_IMPL_LDOUBLE_H
