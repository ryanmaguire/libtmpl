...
#ifndef TMPL_POSITIVE_ARCTAN2_FLOAT_H
#define TMPL_POSITIVE_ARCTAN2_FLOAT_H

/*  Location of the TMPL_INLINE_DECL macro.                                   */
#include <libtmpl/include/tmpl_config.h>

/*  tmpl_Float_Two_Pi provided here.                                          */
...
TMPL_INLINE_DECL
float tmpl_Float_Positive_Arctan2(float y, float x)
{
