 ...
 *      Added inline support. Changed src/math/tmpl_is_nan_float.c to         *
 *      include this file.                                                    *
 ******************************************************************************/

/*  Include guard to prevent including this file twice.                       */
#ifndef TMPL_IS_NAN_FLOAT_H
#define TMPL_IS_NAN_FLOAT_H
...
/*  Function for testing if a float is Not-A-Number (isnanf equivalent).      */
TMPL_INLINE_DECL
tmpl_Bool tmpl_Float_Is_NaN(float x)
{
    ...
    /*  The TMPL_FLOAT_IS_NOT_A_NUMBER macro checks the bits to see if the    *
     *  word represents a NaN. Use this.                                      */
    if (TMPL_FLOAT_IS_NOT_A_NUMBER(w))
        return tmpl_True;
