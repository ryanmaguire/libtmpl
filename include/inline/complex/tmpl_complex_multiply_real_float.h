 ...
 ******************************************************************************
 *                      tmpl_complex_multiply_real_float                      *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_COMPLEX_MULTIPLY_REAL_FLOAT_H
#define TMPL_COMPLEX_MULTIPLY_REAL_FLOAT_H
...
/*  In C99, since _Complex is a built-in type, given float _Complex z and     *
 *  float x, you can just do z*x. With C89 we use structs to define complex   *
 *  numbers. Structs cannot be multiplied, so we need a function for          *
