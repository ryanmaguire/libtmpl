 ...
 ******************************************************************************
 *                      tmpl_complex_quick_divide_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_COMPLEX_QUICK_DIVIDE_DOUBLE_H
#define TMPL_COMPLEX_QUICK_DIVIDE_DOUBLE_H
...
/*  Double precision complex division without overflow / underflow checks.    */
TMPL_INLINE_DECL
tmpl_ComplexDouble
tmpl_CDouble_Quick_Divide(tmpl_ComplexDouble z, tmpl_ComplexDouble w)
{
    ...
    const double factor = 1.0 / (w.dat[0]*w.dat[0] + w.dat[1]*w.dat[1]);
...
/*  End of tmpl_CDouble_Quick_Divide.                                         */
