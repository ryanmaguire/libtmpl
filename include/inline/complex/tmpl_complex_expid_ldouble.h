...
#ifndef TMPL_COMPLEX_EXPID_LDOUBLE_H
#define TMPL_COMPLEX_EXPID_LDOUBLE_H
...
TMPL_INLINE_DECL
tmpl_ComplexLongDouble tmpl_CLDouble_Expid(long double t)
{
    ...
    tmpl_LDouble_SinCosd(t, &z.dat[1], &z.dat[0]);
    return z;
}
/*  End of tmpl_CLDouble_Expid.                                               */
