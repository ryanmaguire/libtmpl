 ...
 ******************************************************************************
 *                    tmpl_complex_horner_sum_real_ldouble                    *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_COMPLEX_HORNER_SUM_REAL_LDOUBLE_H
#define TMPL_COMPLEX_HORNER_SUM_REAL_LDOUBLE_H
                              ...
                              const long double coeff)
{
    ...
    const long double x = self->dat[0];
...
/*  End of tmpl_CLDouble_Horner_Sum_Real.                                     */
