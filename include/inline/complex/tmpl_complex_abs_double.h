 ...
 *          tmpl_CDouble_Quick_Abs, uses the faster and more naive method but *
 ...
 *          the "quick-abs" function is about 1.35x faster and produces the   *
 *          same result for "ordinary" inputs (that is, having components     *
 *          that are zero, or greater than 10^-150 and less than 10^150).     *
 *                                                                            *
