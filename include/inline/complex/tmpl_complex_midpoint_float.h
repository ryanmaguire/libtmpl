 ...
 *  Purpose:                                                                  *
 *      Computes the midpoint of two single precision complex numbers.        *
 *  Arguments:                                                                *
 ...
 *          The tmpl_ComplexFloat typedef is provided here.                   *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
#ifndef TMPL_COMPLEX_MIDPOINT_FLOAT_H
#define TMPL_COMPLEX_MIDPOINT_FLOAT_H
...
TMPL_INLINE_DECL
tmpl_ComplexFloat
tmpl_CFloat_Midpoint(const tmpl_ComplexFloat z, const tmpl_ComplexFloat w)
{
    /*  Output variable for the midpoint of z and w.                          */
    tmpl_ComplexFloat mid;

    /*  The midpoint is computed by averaging the components.                 */
    mid.dat[0] = 0.5F * (z.dat[0] + w.dat[0]);
    mid.dat[1] = 0.5F * (z.dat[1] + w.dat[1]);
    return mid;
}
/*  End of tmpl_CFloat_Midpoint.                                              */
