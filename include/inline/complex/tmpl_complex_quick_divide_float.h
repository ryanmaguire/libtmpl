 ...
 ******************************************************************************
 *                      tmpl_complex_quick_divide_float                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *      2.) Division is not commutative. tmpl_CFloat_Quick_Divide(z, w)       *
 *          returns z / w, and not w / z. That is, the first entry is divided *
 *          by the second one.                                                *
 *      3.) This function is much faster than tmpl_CFloat_Divide, but it is   *
...
#ifndef TMPL_COMPLEX_QUICK_DIVIDE_FLOAT_H
#define TMPL_COMPLEX_QUICK_DIVIDE_FLOAT_H
...
/*  Single precision complex division without overflow / underflow checks.    */
TMPL_INLINE_DECL
tmpl_ComplexFloat
tmpl_CFloat_Quick_Divide(tmpl_ComplexFloat z, tmpl_ComplexFloat w)
{
    ...
    const float factor = 1.0F / (w.dat[0]*w.dat[0] + w.dat[1]*w.dat[1]);
...
/*  End of tmpl_CFloat_Quick_Divide.                                          */
