...
#ifndef TMPL_COMPLEX_POLARD_FLOAT_H
#define TMPL_COMPLEX_POLARD_FLOAT_H
...
TMPL_INLINE_DECL
tmpl_ComplexFloat tmpl_CFloat_Polard(float r, float theta)
{
    /*  Declare necessary variables. C89 requires declarations at the top.    */
    tmpl_ComplexFloat z;

    /*  Compute sind(theta) and cosd(theta) simultaneously.                   */
    tmpl_Float_SinCosd(theta, &z.dat[1], &z.dat[0]);
