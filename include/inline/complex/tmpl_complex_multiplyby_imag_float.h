 ...
 *              tmpl_CFloat_MultiplyBy_Real(&z, x)                            *
 *          instead of writing:                                               *
 *              z = tmpl_CFloat_Multiply_Real(x, z).                          *
...
#ifndef TMPL_COMPLEX_MULTIPLYBY_IMAG_FLOAT_H
#define TMPL_COMPLEX_MULTIPLYBY_IMAG_FLOAT_H
...
/*  End of tmpl_CFloat_MultiplyBy_Imag.                                       */
