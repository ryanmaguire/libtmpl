 ...
 *          The tmpl_ComplexLongDouble typedef is provided here.              *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
#ifndef TMPL_COMPLEX_MIDPOINT_LDOUBLE_H
#define TMPL_COMPLEX_MIDPOINT_LDOUBLE_H
                       ...
                       const tmpl_ComplexLongDouble w)
{
    ...
    tmpl_ComplexLongDouble mid;

    /*  The midpoint is computed by averaging the components.                 */
    mid.dat[0] = 0.5L * (z.dat[0] + w.dat[0]);
    mid.dat[1] = 0.5L * (z.dat[1] + w.dat[1]);
    return mid;
}
/*  End of tmpl_CLDouble_Midpoint.                                            */
