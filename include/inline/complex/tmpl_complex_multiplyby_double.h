 ...
 ******************************************************************************
 *                       tmpl_complex_multiplyby_double                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *              tmpl_CDouble_MultiplyBy(&z, &w)                               *
 *          instead of writing:                                               *
 *              z = tmpl_CDouble_Multiply(z, w).                              *
...
#ifndef TMPL_COMPLEX_MULTIPLYBY_DOUBLE_H
#define TMPL_COMPLEX_MULTIPLYBY_DOUBLE_H
...
TMPL_INLINE_DECL
void
tmpl_CDouble_MultiplyBy(tmpl_ComplexDouble * const z,
...
/*  End of tmpl_CDouble_MultiplyBy.                                           */
