 ...
 ******************************************************************************
 *                      tmpl_complex_subtractfrom_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *              tmpl_CDouble_SubtractFrom(&z, &w)                             *
 *          instead of writing:                                               *
 *              z = tmpl_CDouble_Subtract(z, w).                              *
...
#ifndef TMPL_COMPLEX_SUBTRACTFROM_DOUBLE_H
#define TMPL_COMPLEX_SUBTRACTFROM_DOUBLE_H
...
/*  Double precision complex subtraction. Equivalent of -= operation.         */
TMPL_INLINE_DECL
void
...
/*  End of tmpl_CDouble_SubtractFrom.                                         */
