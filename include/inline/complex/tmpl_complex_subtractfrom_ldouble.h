 ...
 *              tmpl_CLDouble_SubtractFrom(&z, &w)                            *
 *          instead of writing:                                               *
 *              z = tmpl_CLDouble_Subtract(z, w).                             *
...
#ifndef TMPL_COMPLEX_SUBTRACTFROM_LDOUBLE_H
#define TMPL_COMPLEX_SUBTRACTFROM_LDOUBLE_H
 ...
 *  long double _Complex z and long double _Complex w, you can do z -= w.     *
...
/*  End of tmpl_CLDouble_SubtractFrom.                                        */
