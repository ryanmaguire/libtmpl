...
#ifndef TMPL_COMPLEX_FLOAT_MULTIPLY_H
#define TMPL_COMPLEX_FLOAT_MULTIPLY_H
...
#ifndef TMPL_COMPLEX_FLOAT_MULTIPLY_ALGORITHM
#define TMPL_COMPLEX_FLOAT_MULTIPLY_ALGORITHM 0
#endif

/*  Check the value of the macro. 0 corresponds to the classic method, and 1  *
 *  represents the Gauss-Karatsuba algorithm.                                 */
#if TMPL_COMPLEX_FLOAT_MULTIPLY_ALGORITHM == 0
...
#else
/*  Else for #if TMPL_COMPLEX_FLOAT_MULTIPLY_ALGORITHM == 0.                  */
...
tmpl_CFloat_Multiply(tmpl_ComplexFloat z0, tmpl_ComplexFloat z1)
{
    ...
    const float k1 = z1.dat[0] * (z0.dat[0] + z0.dat[1]);
    const float k2 = z0.dat[0] * (z1.dat[1] - z1.dat[0]);
    const float k3 = z0.dat[1] * (z1.dat[0] + z1.dat[1]);
    prod.dat[0] = k1 - k3;
    prod.dat[1] = k1 + k2;
    return prod;
}
...
#endif
/*  End of #if TMPL_COMPLEX_FLOAT_MULTIPLY_ALGORITHM == 0.                    */
