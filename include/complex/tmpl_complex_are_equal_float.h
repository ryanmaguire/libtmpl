 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_CFloat_Are_Equal                                                 *
 *  Purpose:                                                                  *
 *      Checks two complex numbers for equality.                              *
 *  Arguments:                                                                *
 *      z0 (tmpl_ComplexFloat):                                               *
 *          A complex number.                                                 *
 *      z1 (tmpl_ComplexFloat):                                               *
...
#ifndef TMPL_COMPLEX_ARE_EQUAL_FLOAT_H
#define TMPL_COMPLEX_ARE_EQUAL_FLOAT_H
...
TMPL_INLINE_DECL
tmpl_Bool tmpl_CFloat_Are_Equal(tmpl_ComplexFloat z0, tmpl_ComplexFloat z1)
{
