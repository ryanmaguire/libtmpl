...
/******************************************************************************
 *  Function:                                                                 *
 *      tmpl_2DDouble_Y_Reflect                                               *
 *  Purpose:                                                                  *
 *      Reflect a vector across the y axis.                                   *
 *  Arguments:                                                                *
 *      P (const tmpl_TwoVectorDouble * const):                               *
 *          A pointer to a vector in the plane.                               *
 *  Outputs:                                                                  *
 *      y_reflection (tmpl_TwoVectorDouble):                                  *
 *          The reflection of P across the y axis.                            *
 ******************************************************************************/
#if TMPL_USE_INLINE == 1

#include TMPL_INLINE_FILE(tmpl_vec2_y_reflect_double.h)
#include TMPL_INLINE_FILE(tmpl_vec2_y_reflect_float.h)
#include TMPL_INLINE_FILE(tmpl_vec2_y_reflect_ldouble.h)
...
extern tmpl_TwoVectorDouble
tmpl_2DDouble_Y_Reflect(const tmpl_TwoVectorDouble * const P);
...
#include TMPL_INLINE_FILE(tmpl_vec2_y_reflectself_double.h)
#include TMPL_INLINE_FILE(tmpl_vec2_y_reflectself_float.h)
#include TMPL_INLINE_FILE(tmpl_vec2_y_reflectself_ldouble.h)

#else

extern void tmpl_2DFloat_Y_ReflectSelf(tmpl_TwoVectorFloat * const P);
extern void tmpl_2DDouble_Y_ReflectSelf(tmpl_TwoVectorDouble * const P);
extern void tmpl_2DLDouble_Y_ReflectSelf(tmpl_TwoVectorLongDouble * const P);
