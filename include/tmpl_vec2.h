 ...
 ******************************************************************************/
TMPL_EXPORT externloat tmpl_2x2Float_Determinant(const tmpl_TwoByTwoMatrixFloat *A);
TMPL_EXPORT externouble tmpl_2x2Double_Determinant(const tmpl_TwoByTwoMatrixDouble *A);
 ...
 *      Float and Long Double precisions are also provided.                   *
 ******************************************************************************/
TMPL_EXPORT externmpl_TwoByTwoMatrixFloat
tmpl_2x2Float_Inverse(const tmpl_TwoByTwoMatrixFloat *A);

TMPL_EXPORT externmpl_TwoByTwoMatrixDouble
tmpl_2x2Double_Inverse(const tmpl_TwoByTwoMatrixDouble *A);

TMPL_EXPORT externmpl_TwoByTwoMatrixLongDouble
 ...
 *          The rotation matrix.                                              *
 ******************************************************************************/
TMPL_EXPORT externmpl_TwoByTwoMatrixFloat tmpl_2x2Float_Rotation(float theta);
TMPL_EXPORT externmpl_TwoByTwoMatrixDouble tmpl_2x2Double_Rotation(double theta);
 ...
 *      The source code is contained in src/kissvg.c                          *
 ******************************************************************************/
TMPL_EXPORT externmpl_TwoVectorFloat tmpl_2DFloat_Rect(float x, float y);
TMPL_EXPORT externmpl_TwoVectorDouble tmpl_2DDouble_Rect(double x, double y);
 ...
 ******************************************************************************/
TMPL_EXPORT externloat tmpl_2DFloat_X(const tmpl_TwoVectorFloat *P);
TMPL_EXPORT externouble tmpl_2DDouble_X(const tmpl_TwoVectorDouble *P);
TMPL_EXPORT externong double tmpl_2DLDouble_X(const tmpl_TwoVectorLongDouble *P);
 ...
 *      This is not a function, but rather a preprocessor macro.              *
 ******************************************************************************/
TMPL_EXPORT externloat tmpl_2DFloat_Y(const tmpl_TwoVectorFloat *P);
TMPL_EXPORT externouble tmpl_2DDouble_Y(const tmpl_TwoVectorDouble *P);
TMPL_EXPORT externong double tmpl_2DLDouble_Y(const tmpl_TwoVectorLongDouble *P);
...
TMPL_EXPORT externmpl_TwoVectorFloat tmpl_2DFloat_Polar(float r, float theta);
TMPL_EXPORT externmpl_TwoVectorDouble tmpl_2DDouble_Polar(double r, double theta);
...
#else
TMPL_EXPORT externloat tmpl_2DFloat_L2_Norm(const tmpl_TwoVectorFloat *P);
TMPL_EXPORT externouble tmpl_2DDouble_L2_Norm(const tmpl_TwoVectorDouble *P);
TMPL_EXPORT externong double tmpl_2DLDouble_L2_Norm(const tmpl_TwoVectorLongDouble *P);
#endif
 ...
 ******************************************************************************/
TMPL_EXPORT externloat tmpl_2DFloat_L2_Norm_Squared(const tmpl_TwoVectorFloat *P);
TMPL_EXPORT externouble tmpl_2DDouble_L2_Norm_Squared(const tmpl_TwoVectorDouble *P);
...
TMPL_EXPORT externmpl_2DCircleDouble
