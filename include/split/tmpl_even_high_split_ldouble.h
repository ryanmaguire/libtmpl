...
#ifndef TMPL_SPLIT_EVEN_HIGH_SPLIT_LDOUBLE_H
#define TMPL_SPLIT_EVEN_HIGH_SPLIT_LDOUBLE_H
...
TMPL_CONST_FUNC
extern long double
tmpl_LDouble_Even_High_Split(const long double x) TMPL_UNSEQUENCED;
