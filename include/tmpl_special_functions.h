...
extern float tmpl_Float_Bessel_J0_Asym[5];

extern double tmpl_Double_Bessel_J0_Taylor[25];
extern double tmpl_Double_Bessel_J0_Asym[7];

extern long double tmpl_LDouble_Bessel_J0_Taylor[29];
