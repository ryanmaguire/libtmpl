...
#ifndef TMPL_VEC3_PROJECTION_DOUBLE_H
#define TMPL_VEC3_PROJECTION_DOUBLE_H
                         ...
                         const tmpl_ThreeVectorDouble * const Q)
{
    ...
    return tmpl_3DDouble_Dot_Product(P, &Qn);
}
/*  End of tmpl_3DDouble_Projection.                                          */
