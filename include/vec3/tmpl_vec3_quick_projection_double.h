 ...
 ******************************************************************************
 *                     tmpl_vec3_quick_projection_double                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Contains code for vector projection at double precision.              *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_3DDouble_Quick_Projection                                        *
 *  Purpose:                                                                  *
 ...
 *          with very large components, use tmpl_3DDouble_Projection. That    *
...
#ifndef TMPL_VEC3_QUICK_PROJECTION_DOUBLE_H
#define TMPL_VEC3_QUICK_PROJECTION_DOUBLE_H
                               ...
                               const tmpl_ThreeVectorDouble * const Q)
{
    ...
    return tmpl_3DDouble_Dot_Product(P, Q) / tmpl_3DDouble_L2_Norm_Squared(Q);
}
/*  End of tmpl_3DDouble_Quick_Projection.                                    */
