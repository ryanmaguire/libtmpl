 ...
 *          use tmpl_3DFloat_Orthogonal_Part. That function safely handles    *
...
#ifndef TMPL_VEC3_QUICK_ORTHOGONAL_PART_FLOAT_H
#define TMPL_VEC3_QUICK_ORTHOGONAL_PART_FLOAT_H
                                   ...
                                   const tmpl_ThreeVectorFloat * const Q)
{
    ...
    const tmpl_ThreeVectorFloat component
        = tmpl_3DFloat_Quick_Component(P, Q);
    return tmpl_3DFloat_Subtract(P, &component);
}
/*  End of tmpl_3DFloat_Quick_Orthogonal_Part.                                */
