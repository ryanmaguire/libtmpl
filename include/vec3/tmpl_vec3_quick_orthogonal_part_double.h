 ...
 ******************************************************************************
 *                   tmpl_vec3_quick_orthogonal_part_double                   *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_3DDouble_Quick_Orthogonal_Part                                   *
 *  Purpose:                                                                  *
 ...
 *          use tmpl_3DDouble_Orthogonal_Part. That function safely handles   *
...
#ifndef TMPL_VEC3_QUICK_ORTHOGONAL_PART_DOUBLE_H
#define TMPL_VEC3_QUICK_ORTHOGONAL_PART_DOUBLE_H
                                    ...
                                    const tmpl_ThreeVectorDouble * const Q)
{
    ...
    const tmpl_ThreeVectorDouble component
        = tmpl_3DDouble_Quick_Component(P, Q);
    return tmpl_3DDouble_Subtract(P, &component);
}
/*  End of tmpl_3DDouble_Quick_Orthogonal_Part.                               */
