 ...
 ******************************************************************************
 *                       tmpl_vec3_quick_l2_norm_double                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 *      3.) Unlike tmpl_3DDouble_L2_Norm, this function does not prevent      *
...
#ifndef TMPL_VEC3_QUICK_L2_NORM_DOUBLE_H
#define TMPL_VEC3_QUICK_L2_NORM_DOUBLE_H
...
TMPL_INLINE_DECL
double tmpl_3DDouble_Quick_L2_Norm(const tmpl_ThreeVectorDouble * const P)
{
    /*  The hypot3 function computes using the Pythagoras formula. Use this.  */
    return tmpl_Double_Quick_Hypot3(P->dat[0], P->dat[1], P->dat[2]);
}
/*  End of tmpl_3DDouble_Quick_L2_Norm.                                       */
