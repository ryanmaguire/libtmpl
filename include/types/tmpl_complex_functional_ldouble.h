 ...
 ******************************************************************************
 *                       tmpl_complex_functional_ldouble                      *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides the function type complex long double -> long double.        *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
#ifndef TMPL_TYPES_COMPLEX_FUNCTIONAL_LDOUBLE_H
#define TMPL_TYPES_COMPLEX_FUNCTIONAL_LDOUBLE_H
