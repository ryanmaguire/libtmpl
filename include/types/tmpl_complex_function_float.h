 ...
 ******************************************************************************
 *                         tmpl_complex_function_float                        *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides the function type complex float -> complex float.            *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
#ifndef TMPL_TYPES_COMPLEX_FUNCTION_FLOAT_H
#define TMPL_TYPES_COMPLEX_FUNCTION_FLOAT_H
