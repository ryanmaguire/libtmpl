 ...
 ******************************************************************************
 *                         tmpl_point_charge_double                           *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides the definition of a point charge at double precision.        *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       July 17, 2026                                                 *
 ******************************************************************************/
...
#ifndef TMPL_TYPES_POINT_CHARGE_DOUBLE_H
#define TMPL_TYPES_POINT_CHARGE_DOUBLE_H

/*  Vec3's are used for the position and velocity vectors of the charge.      */
#include <libtmpl/include/types/tmpl_vec3_double.h>

/*  Struct for a double-precision point-charge in three space.                */
typedef struct tmpl_PointChargeDouble_Type {

    /*  The position in three space for the point charge.                     */
    tmpl_ThreeVectorDouble pos;

    /*  The velocity vector for the charge.                                   */
    tmpl_ThreeVectorDouble vel;
