...
#ifndef TMPL_OPTICAL_PHASE_FLOAT_H
#define TMPL_OPTICAL_PHASE_FLOAT_H
...
TMPL_INLINE_DECL
float tmpl_CFloat_Optical_Phase(tmpl_ComplexFloat transmittance)
{
    ...
    return tmpl_Float_Arctan2(transmittance.dat[1], transmittance.dat[0]);
}
/*  End of tmpl_CFloat_Optical_Phase.                                         */
