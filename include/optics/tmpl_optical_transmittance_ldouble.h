 ...
 ******************************************************************************
 *                     tmpl_optical_transmittance_ldouble                     *
 ******************************************************************************
 *  Purpose:                                                                  *
 ...
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_CLDouble_Optical_Transmittance                                   *
 *  Purpose:                                                                  *
...
#ifndef TMPL_OPTICAL_TRANSMITTANCE_LDOUBLE_H
#define TMPL_OPTICAL_TRANSMITTANCE_LDOUBLE_H
...
tmpl_CLDouble_Optical_Transmittance(long double power, long double phase)
{
    ...
    return tmpl_CLDouble_Polar(radius, phase);
}
/*  End of tmpl_CLDouble_Optical_Transmittance.                               */
