 ...
 ******************************************************************************
 *                   tmpl_optical_transmittance_deg_double                    *
 ******************************************************************************
 *  Purpose:                                                                  *
...
#ifndef TMPL_OPTICAL_TRANSMITTANCE_DEG_DOUBLE_H
#define TMPL_OPTICAL_TRANSMITTANCE_DEG_DOUBLE_H
...
#include <libtmpl/include/tmpl_complex_polard_double.h>
...
tmpl_CDouble_Optical_Transmittance_Deg(double power, double phase)
{
    ...
    return tmpl_CDouble_Polard(radius, phase);
}
/*  End of tmpl_CDouble_Optical_Transmittance_Deg.                            */
