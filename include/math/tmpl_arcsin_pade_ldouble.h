 ...
 *      and denominator.                                                      *
 *                                                                            *
 *          asin(x) - x   a0 + a1*x^2 + a2*x^4 + a3*x^6 + a4*x^8 + a5*x^10    *
 *          ----------- = ------------------------------------------------    *
...
/*  Function for computing the (10, 8) Pade approximant of asin(x).           */
TMPL_INLINE_DECL
...
/*  Function for computing the (18, 18) Pade approximant of asin(x).          */
TMPL_INLINE_DECL
long double tmpl_LDouble_Arcsin_Pade(long double x)
{
    /*  The polynomials for the numerator and denominator are in terms of x^2.*/
...
/*  Function for computing the (12, 10) Pade approximant of asin(x).          */
TMPL_INLINE_DECL
long double tmpl_LDouble_Arcsin_Pade(long double x)
{
    /*  The polynomials for the numerator and denominator are in terms of x^2.*/
