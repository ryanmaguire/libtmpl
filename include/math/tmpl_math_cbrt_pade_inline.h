 ...
 ******************************************************************************/
#ifndef TMPL_MATH_CBRT_PADE_INLINE_H
#define TMPL_MATH_CBRT_PADE_INLINE_H
...
static inline double tmpl_Double_Cbrt_Pade(double x)
{
...
/*  Undefine all macros so we can re-use them for single precision.           */
#undef P0
#undef P1
#undef P2
#undef P3
...
/*  Function for computing the (7, 7) Pade approximate of cbrt(x) at x = 1.   */
static inline float tmpl_Float_Cbrt_Pade(float x)
{
    /*  The approximant is computed at x = 1. Shift the input.                */
...
/*  Undefine all macros so we can re-use them for long double precision.      */
#undef P0
#undef P1
#undef P2
#undef P3
...
/*  Function for computing the (7, 7) Pade approximate of cbrt(x) at x = 1.   */
static inline long double tmpl_LDouble_Cbrt_Pade(long double x)
{
    /*  The approximant is computed at x = 1. Shift the input.                */
