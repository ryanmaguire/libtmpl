 ...
 *      Added inline support. Changed src/math/tmpl_is_nan_ldouble.c to       *
 *      include this file.                                                    *
 ******************************************************************************/

/*  Include guard to prevent including this file twice.                       */
#ifndef TMPL_IS_NAN_LDOUBLE_H
#define TMPL_IS_NAN_LDOUBLE_H
...
/*  Function for testing if a long double is Not-A-Number (isnanl equivalent).*/
TMPL_INLINE_DECL
tmpl_Bool tmpl_LDouble_Is_NaN(long double x)
{
    ...
    /*  The TMPL_LDOUBLE_IS_NOT_A_NUMBER macro checks the bits to see if the  *
     *  word represents a NaN. Use this.                                      */
    if (TMPL_LDOUBLE_IS_NOT_A_NUMBER(w))
        return tmpl_True;
...
tmpl_Bool tmpl_LDouble_Is_NaN(long double x)
{
    ...
    const volatile long double y = x;
