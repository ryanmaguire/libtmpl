...
#ifndef TMPL_IS_NAN_OR_INF_LDOUBLE_H
#define TMPL_IS_NAN_OR_INF_LDOUBLE_H
...
/*  Function for testing if a long double is Not-A-Number or infinity.        */
TMPL_INLINE_DECL
tmpl_Bool tmpl_LDouble_Is_NaN_Or_Inf(long double x)
{
     ...
     *  the macro TMPL_LDOUBLE_IS_NAN_OR_INF to check for this.               */
