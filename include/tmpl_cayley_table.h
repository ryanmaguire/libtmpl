 ...
 *  Purpose:                                                                  *
 *      Checks if a Cayley table is right self-distributive, meaning:         *
 *                                                                            *
 *          (x * y) * z = (x * z) * (y * z)                                   *
 *                                                                            *
 *      for all x, y, z in the underlying set.                                *
 ...
 *  Purpose:                                                                  *
 *      Main part of the right self-distributivity checker, this loops over   *
 *      ordered triples (x, y, z) and checks (x*y)*z = (x*z)*(y*z).           *
 *  Arguments:                                                                *
 *      table (const tmpl_UIntCayleyTable * const):                           *
 *          The input Cayley table.                                           *
 *  Output:                                                                   *
 ...
 *  Purpose:                                                                  *
 *      Checks if a Cayley table is self-distributive, meaning:               *
 *                                                                            *
 *          x * (y * z) = (x * y) * (x * z)                                   *
 *          (x * y) * z = (x * z) * (y * z)                                   *
 *                                                                            *
 ...
 *  Purpose:                                                                  *
 *      Main part of the right self-distributivity checker, this loops over   *
 *      ordered triples (x, y, z) and checks x*(y*z) = (x*y)*(x*z) and        *
 *       (x*y)*z = (x*z)*(y*z).                                               *
 *  Arguments:                                                                *
 *      table (const tmpl_UIntCayleyTable * const):                           *
 *          The input Cayley table.                                           *
