...
#ifndef TMPL_TWO_SUM_FAST_TWO_SUM_LDOUBLE_H
#define TMPL_TWO_SUM_FAST_TWO_SUM_LDOUBLE_H

/*  The TMPL_USE_INLINE and TMPL_RESTRICT macros are found here.              */
#include <libtmpl/include/tmpl_config.h>

/*  Fast2Sum is small enough that it should be inlined. Check for support.    */
