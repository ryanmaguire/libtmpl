...
#ifndef TMPL_TWO_SUM_NEUMAIER_TWO_SUM_FLOAT_H
#define TMPL_TWO_SUM_NEUMAIER_TWO_SUM_FLOAT_H
...
#include <libtmpl/include/inline/two_sum/tmpl_neumaier_two_sum_float.h>
