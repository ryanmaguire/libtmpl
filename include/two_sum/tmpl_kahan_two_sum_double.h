...
#ifndef TMPL_TWO_SUM_KAHAN_TWO_SUM_DOUBLE_H
#define TMPL_TWO_SUM_KAHAN_TWO_SUM_DOUBLE_H
...
#include <libtmpl/include/inline/two_sum/tmpl_kahan_two_sum_double.h>
