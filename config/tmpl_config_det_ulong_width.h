 ...
 ******************************************************************************
 *                        tmpl_config_det_ulong_width                         *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Determines the width of unsigned long int.                            *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 ...
 *  Purpose:                                                                  *
 *      Determines the number of numerical bits in unsigned long int.         *
 *  Arguments:                                                                *
 *      None (void).                                                          *
 *  Output:                                                                   *
 *      None (void).                                                          *
...
#ifndef TMPL_CONFIG_DET_ULONG_WIDTH_H
#define TMPL_CONFIG_DET_ULONG_WIDTH_H

/*  Globals for the config file are all found here.                           */
#include "tmpl_config_globals.h"

/*  The width of unsigned char can be used to compute the size of long.       */
#include "tmpl_config_det_uchar_width.h"

/*  Function for determining the number of bits in unsigned long int.         */
static void tmpl_det_ulong_width(void)
{
    ...
    const unsigned long int two = 2UL;
     ...
     *  sizeof operator. The C standard allows unsigned long to have padding, *
