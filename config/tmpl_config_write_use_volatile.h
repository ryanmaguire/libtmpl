 ...
 ******************************************************************************
 *                       tmpl_config_write_use_volatile                       *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Writes the TMPL_VOLATILE macro to a file.                             *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      tmpl_write_use_volatile                                               *
 *  Purpose:                                                                  *
 *      Writes the TMPL_VOLATILE macro to a file.                             *
 *  Arguments:                                                                *
 *      fp (FILE *):                                                          *
 ...
 *  Method:                                                                   *
 *      Check the TMPL_USE_VOLATILE macro and C99 support and then call fputs.*
 ******************************************************************************
 *                                DEPENDENCIES                                *
 ******************************************************************************
 *  1.) stdio.h:                                                              *
...
#ifndef TMPL_CONFIG_WRITE_USE_VOLATILE_H
#define TMPL_CONFIG_WRITE_USE_VOLATILE_H
...
#else
    fputs("#define TMPL_VOLATILE\n\n", fp);
#endif
}
/*  End of tmpl_write_use_volatile.                                           */
