...
static unsigned int tmpl_has_8_bit_uint = 0U;
static unsigned int tmpl_has_16_bit_uint = 0U;
static unsigned int tmpl_has_32_bit_uint = 0U;
static unsigned int tmpl_has_64_bit_uint = 0U;
static unsigned int tmpl_has_128_bit_uint = 0U;

static unsigned int tmpl_has_8_bit_sint = 0U;
static unsigned int tmpl_has_16_bit_sint = 0U;
static unsigned int tmpl_has_32_bit_sint = 0U;
static unsigned int tmpl_has_64_bit_sint = 0U;
static unsigned int tmpl_has_128_bit_sint = 0U;
